...
Inheritance
------------
* pycraft.server.final.AbstractArrow
...
Python Proxy to `org.bukkit.entity.AbstractArrow <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/AbstractArrow.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: AbstractArrow(self, **named)
   :canonical: pycraft.server.final.AbstractArrow
