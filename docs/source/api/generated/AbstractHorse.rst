...
Inheritance
------------
* pycraft.server.final.AbstractHorse
...
Python Proxy to `org.bukkit.entity.AbstractHorse <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/AbstractHorse.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: AbstractHorse(self, **named)
   :canonical: pycraft.server.final.AbstractHorse
