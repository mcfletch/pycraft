...
Inheritance
------------
* pycraft.server.final.AbstractSkeleton
...
Python Proxy to `org.bukkit.entity.AbstractSkeleton <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/AbstractSkeleton.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: AbstractSkeleton(self, **named)
   :canonical: pycraft.server.final.AbstractSkeleton
