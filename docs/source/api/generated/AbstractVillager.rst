...
Inheritance
------------
* pycraft.server.final.AbstractVillager
...
Python Proxy to `org.bukkit.entity.AbstractVillager <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/AbstractVillager.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: AbstractVillager(self, **named)
   :canonical: pycraft.server.final.AbstractVillager
