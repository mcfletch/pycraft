...
Inheritance
------------
* pycraft.server.final.Action
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.event.block.Action <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/event/block/Action.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Action(self, key)
   :canonical: pycraft.server.final.Action
   ...
   .. py:method:: isLeftClick(self) -> bool
      :async:


   .. py:method:: isRightClick(self) -> bool
      :async:
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Action`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Action`]
      :async:
      :classmethod:
