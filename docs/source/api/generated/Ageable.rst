...
Python Proxy to `org.bukkit.entity.Ageable <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Ageable.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Ageable(self, **named)
   :canonical: pycraft.server.final.Ageable
