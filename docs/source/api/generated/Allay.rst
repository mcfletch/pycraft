...
Python Proxy to `org.bukkit.entity.Allay <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Allay.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Allay(self, **named)
   :canonical: pycraft.server.final.Allay
   ...
   .. py:method:: canDuplicate(self) -> bool
      :async:
   ...
   .. py:method:: duplicateAllay(self) -> :py:class:`Allay`
      :async:
   ...
   .. py:method:: getDuplicationCooldown(self) -> :py:class:`long`
      :async:
   ...
   .. py:method:: getJukebox(self) -> :py:class:`Location`
      :async:
   ...
   .. py:method:: resetDuplicationCooldown(self) -> None
      :async:
   ...
   .. py:method:: setCanDuplicate(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setDuplicationCooldown(self, _0:long) -> None
      :async:
   ...
   .. py:method:: startDancing

       .. py:method:: startDancing(self) -> None
          :async:
          :noindex:

       .. py:method:: startDancing(self, _0:Location) -> None
          :async:
          :noindex:


   .. py:method:: stopDancing(self) -> None
      :async:
