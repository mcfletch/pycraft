...
Python Proxy to `org.bukkit.entity.Ambient <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Ambient.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Ambient(self, **named)
   :canonical: pycraft.server.final.Ambient
