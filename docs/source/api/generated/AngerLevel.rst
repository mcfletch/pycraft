...
Inheritance
------------
* pycraft.server.final.AngerLevel
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.Warden.AngerLevel <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Warden/AngerLevel.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: AngerLevel(self, key)
   :canonical: pycraft.server.final.AngerLevel
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`AngerLevel`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`AngerLevel`]
      :async:
      :classmethod:
