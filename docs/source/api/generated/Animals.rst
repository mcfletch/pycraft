...
Python Proxy to `org.bukkit.entity.Animals <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Animals.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Animals(self, **named)
   :canonical: pycraft.server.final.Animals
