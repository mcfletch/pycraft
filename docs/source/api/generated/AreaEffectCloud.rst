...
Inheritance
------------
* pycraft.server.final.AreaEffectCloud
...
Python Proxy to `org.bukkit.entity.AreaEffectCloud <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/AreaEffectCloud.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: AreaEffectCloud(self, **named)
   :canonical: pycraft.server.final.AreaEffectCloud
   ...
   .. py:method:: getDurationOnUse(self) -> int
      :async:
   ...
   .. py:method:: getParticle(self) -> :py:class:`Particle`
      :async:
   ...
   .. py:method:: getRadius(self) -> float
      :async:


   .. py:method:: getRadiusOnUse(self) -> float
      :async:


   .. py:method:: getRadiusPerTick(self) -> float
      :async:


   .. py:method:: getReapplicationDelay(self) -> int
      :async:
   ...
   .. py:method:: getSource(self) -> :py:class:`ProjectileSource`
      :async:
   ...
   .. py:method:: getWaitTime(self) -> int
      :async:
   ...
   .. py:method:: setDuration(self, _0:int) -> None
      :async:


   .. py:method:: setDurationOnUse(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setParticle

       .. py:method:: setParticle(self, _0:Particle) -> None
          :async:
          :noindex:

       .. py:method:: setParticle(self, _0:Particle, _1:Object) -> None
          :async:
          :noindex:
   ...
   .. py:method:: setRadius(self, _0:float) -> None
      :async:


   .. py:method:: setRadiusOnUse(self, _0:float) -> None
      :async:


   .. py:method:: setRadiusPerTick(self, _0:float) -> None
      :async:


   .. py:method:: setReapplicationDelay(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setSource(self, _0:ProjectileSource) -> None
      :async:
