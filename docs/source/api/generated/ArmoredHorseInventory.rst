...
Inheritance
------------
* pycraft.server.final.ArmoredHorseInventory
...
Python Proxy to `org.bukkit.inventory.ArmoredHorseInventory <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/ArmoredHorseInventory.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: ArmoredHorseInventory(self, *args, **named)
   :canonical: pycraft.server.final.ArmoredHorseInventory
