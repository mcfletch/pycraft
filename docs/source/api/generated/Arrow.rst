...
Inheritance
------------
* pycraft.server.final.Arrow
* :py:class:`pycraft.server.final.AbstractArrow`
* :py:class:`pycraft.server.final.Projectile`
...
Python Proxy to `org.bukkit.entity.Arrow <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Arrow.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Arrow(self, **named)
   :canonical: pycraft.server.final.Arrow
   ...
   .. py:method:: addCustomEffect(self, _0:PotionEffect, _1:boolean) -> bool
      :async:
   ...
   .. py:method:: canHitEntity(self, _0:Entity) -> bool
      :async:


   .. py:method:: clearCustomEffects(self) -> None
      :async:
   ...
   .. py:method:: doesBounce(self) -> bool
      :async:
   ...
   .. py:method:: getAttachedBlock(self) -> :py:class:`Block`
      :async:


   .. py:method:: getBasePotionData(self) -> :py:class:`PotionData`
      :async:
   ...
   .. py:method:: getCustomEffects(self) -> typing.List[:py:class:`PotionEffect`]
      :async:
   ...
   .. py:method:: getItemStack(self) -> :py:class:`ItemStack`
      :async:


   .. py:method:: getKnockbackStrength(self) -> int
      :async:
   ...
   .. py:method:: getLifetimeTicks(self) -> int
      :async:
   ...
   .. py:method:: getPickupRule(self) -> :py:class:`PickupRule`
      :async:


   .. py:method:: getPickupStatus(self) -> :py:class:`PickupStatus`
      :async:


   .. py:method:: getPierceLevel(self) -> int
      :async:
   ...
   .. py:method:: getShooter(self) -> :py:class:`ProjectileSource`
      :async:
   ...
   .. py:method:: hasBeenShot(self) -> bool
      :async:


   .. py:method:: hasCustomEffect(self, _0:PotionEffectType) -> bool
      :async:


   .. py:method:: hasCustomEffects(self) -> bool
      :async:
   ...
   .. py:method:: hasLeftShooter(self) -> bool
      :async:
   ...
   .. py:method:: hasNoPhysics(self) -> bool
      :async:
   ...
   .. py:method:: hitEntity
       ...
       .. py:method:: hitEntity(self, _0:Entity) -> None
          :async:
          :noindex:

       .. py:method:: hitEntity(self, _0:Entity, _1:Vector) -> None
          :async:
          :noindex:
   ...
   .. py:method:: isCritical(self) -> bool
      :async:
   ...
   .. py:method:: isShotFromCrossbow(self) -> bool
      :async:
   ...
   .. py:method:: removeCustomEffect(self, _0:PotionEffectType) -> bool
      :async:
   ...
   .. py:method:: setBasePotionData(self, _0:PotionData) -> None
      :async:


   .. py:method:: setBounce(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setCritical(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setHasBeenShot(self, _0:boolean) -> None
      :async:


   .. py:method:: setHasLeftShooter(self, _0:boolean) -> None
      :async:


   .. py:method:: setHitSound(self, _0:Sound) -> None
      :async:
   ...
   .. py:method:: setKnockbackStrength(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setLifetimeTicks(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setNoPhysics(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setPickupRule(self, _0:PickupRule) -> None
      :async:


   .. py:method:: setPickupStatus(self, _0:PickupStatus) -> None
      :async:


   .. py:method:: setPierceLevel(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setShooter(self, _0:ProjectileSource) -> None
      :async:


   .. py:method:: setShotFromCrossbow(self, _0:boolean) -> None
      :async:
