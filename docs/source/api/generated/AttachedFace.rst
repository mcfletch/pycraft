...
Inheritance
------------
* pycraft.server.final.AttachedFace
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.block.data.FaceAttachable.AttachedFace <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/FaceAttachable/AttachedFace.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: AttachedFace(self, key)
   :canonical: pycraft.server.final.AttachedFace
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`AttachedFace`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`AttachedFace`]
      :async:
      :classmethod:
