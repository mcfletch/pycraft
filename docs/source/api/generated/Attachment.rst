...
Inheritance
------------
* pycraft.server.final.Attachment
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.block.data.type.Bell.Attachment <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Bell/Attachment.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Attachment(self, key)
   :canonical: pycraft.server.final.Attachment
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Attachment`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Attachment`]
      :async:
      :classmethod:
