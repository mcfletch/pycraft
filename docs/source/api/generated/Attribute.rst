...
Inheritance
------------
* pycraft.server.final.Attribute
...
Python Proxy to `org.bukkit.attribute.Attribute <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/attribute/Attribute.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Attribute(self, key)
   :canonical: pycraft.server.final.Attribute
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Attribute`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Attribute`]
      :async:
      :classmethod:
