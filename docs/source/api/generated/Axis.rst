...
Inheritance
------------
* pycraft.server.final.Axis
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.Axis <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/Axis.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Axis(self, key)
   :canonical: pycraft.server.final.Axis
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Axis`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Axis`]
      :async:
      :classmethod:
