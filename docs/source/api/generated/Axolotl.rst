...
Python Proxy to `org.bukkit.entity.Axolotl <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Axolotl.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Axolotl(self, **named)
   :canonical: pycraft.server.final.Axolotl
   ...
   .. py:method:: getBaseBucketItem(self) -> :py:class:`ItemStack`
      :async:
   ...
   .. py:method:: getPickupSound(self) -> :py:class:`Sound`
      :async:
   ...
   .. py:method:: isFromBucket(self) -> bool
      :async:
   ...
   .. py:method:: isPlayingDead(self) -> bool
      :async:
   ...
   .. py:method:: setFromBucket(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setPlayingDead(self, _0:boolean) -> None
      :async:
