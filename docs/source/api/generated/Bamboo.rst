...
Inheritance
------------
* pycraft.server.final.Bamboo
* :py:class:`pycraft.server.world.Bamboo`
...
* :py:class:`pycraft.server.final.Sapling`
* :py:class:`pycraft.server.world.Sapling`
* :py:class:`pycraft.server.final.BlockData`
* :py:class:`pycraft.server.world.BlockData`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.block.data.type.Bamboo <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Bamboo.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Bamboo(self, string_value=None, **named)
   :canonical: pycraft.server.final.Bamboo
   ...
   .. py:method:: getLeaves(self) -> :py:class:`Leaves`
      :async:
   ...
   .. py:method:: getMaximumAge(self) -> int
      :async:
   ...
   .. py:method:: getMaximumStage(self) -> int
      :async:
   ...
   .. py:method:: setLeaves(self, _0:Leaves) -> None
      :async:
   ...
   .. py:method:: setStage(self, _0:int) -> None
      :async:
