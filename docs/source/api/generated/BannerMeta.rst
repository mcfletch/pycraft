...
Inheritance
------------
* pycraft.server.final.BannerMeta
...
Python Proxy to `org.bukkit.inventory.meta.BannerMeta <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/meta/BannerMeta.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: BannerMeta(self, **named)
   :canonical: pycraft.server.final.BannerMeta
   ...
   .. py:method:: addPattern(self, _0:Pattern) -> None
      :async:
   ...
   .. py:method:: getBaseColor(self) -> :py:class:`DyeColor`
      :async:
   ...
   .. py:method:: getPattern(self, _0:int) -> :py:class:`Pattern`
      :async:


   .. py:method:: getPatterns(self) -> typing.List[:py:class:`Pattern`]
      :async:
   ...
   .. py:method:: numberOfPatterns(self) -> int
      :async:
   ...
   .. py:method:: removePattern(self, _0:int) -> :py:class:`Pattern`
      :async:
   ...
   .. py:method:: setBaseColor(self, _0:DyeColor) -> None
      :async:
   ...
   .. py:method:: setPattern(self, _0:int, _1:Pattern) -> None
      :async:


   .. py:method:: setPatterns(self, _0:List) -> None
      :async:
