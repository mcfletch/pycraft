...
Inheritance
------------
* pycraft.server.final.BarColor
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.boss.BarColor <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/boss/BarColor.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: BarColor(self, key)
   :canonical: pycraft.server.final.BarColor
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`BarColor`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`BarColor`]
      :async:
      :classmethod:
