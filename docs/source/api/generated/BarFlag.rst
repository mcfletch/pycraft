...
Inheritance
------------
* pycraft.server.final.BarFlag
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.boss.BarFlag <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/boss/BarFlag.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: BarFlag(self, key)
   :canonical: pycraft.server.final.BarFlag
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`BarFlag`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`BarFlag`]
      :async:
      :classmethod:
