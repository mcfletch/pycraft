...
Inheritance
------------
* pycraft.server.final.BarStyle
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.boss.BarStyle <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/boss/BarStyle.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: BarStyle(self, key)
   :canonical: pycraft.server.final.BarStyle
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`BarStyle`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`BarStyle`]
      :async:
      :classmethod:
