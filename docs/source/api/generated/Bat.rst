...
Inheritance
------------
* pycraft.server.final.Bat
* :py:class:`pycraft.server.final.Ambient`
...
Python Proxy to `org.bukkit.entity.Bat <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Bat.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Bat(self, **named)
   :canonical: pycraft.server.final.Bat
   ...
   .. py:method:: setAwake(self, _0:boolean) -> None
      :async:
