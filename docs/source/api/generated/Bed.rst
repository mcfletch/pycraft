...
Inheritance
------------
* pycraft.server.final.Bed
* :py:class:`pycraft.server.world.Bed`
...
Python Proxy to `org.bukkit.block.data.type.Bed <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Bed.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Bed(self, string_value=None, **named)
   :canonical: pycraft.server.final.Bed
   ...
   .. py:method:: getPart(self) -> :py:class:`Part`
      :async:
   ...
   .. py:method:: isOccupied(self) -> bool
      :async:
   ...
   .. py:method:: setOccupied(self, _0:boolean) -> None
      :async:


   .. py:method:: setPart(self, _0:Part) -> None
      :async:
