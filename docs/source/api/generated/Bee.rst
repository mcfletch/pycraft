...
Python Proxy to `org.bukkit.entity.Bee <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Bee.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Bee(self, **named)
   :canonical: pycraft.server.final.Bee
   ...
   .. py:method:: getCannotEnterHiveTicks(self) -> int
      :async:
   ...
   .. py:method:: getCropsGrownSincePollination(self) -> int
      :async:
   ...
   .. py:method:: getFlower(self) -> :py:class:`Location`
      :async:
   ...
   .. py:method:: getHive(self) -> :py:class:`Location`
      :async:
   ...
   .. py:method:: getRollingOverride(self) -> :py:class:`TriState`
      :async:
   ...
   .. py:method:: getTicksSincePollination(self) -> int
      :async:
   ...
   .. py:method:: setAnger(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setCannotEnterHiveTicks(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setCropsGrownSincePollination(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setFlower(self, _0:Location) -> None
      :async:
   ...
   .. py:method:: setHasNectar(self, _0:boolean) -> None
      :async:


   .. py:method:: setHasStung(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setHive(self, _0:Location) -> None
      :async:
   ...
   .. py:method:: setRollingOverride(self, _0:TriState) -> None
      :async:
   ...
   .. py:method:: setTicksSincePollination(self, _0:int) -> None
      :async:
