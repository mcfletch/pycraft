...
Inheritance
------------
* pycraft.server.final.Beehive
* :py:class:`pycraft.server.world.Beehive`
...
Python Proxy to `org.bukkit.block.data.type.Beehive <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Beehive.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Beehive(self, string_value=None, **named)
   :canonical: pycraft.server.final.Beehive
   ...
   .. py:method:: getHoneyLevel(self) -> int
      :async:
   ...
   .. py:method:: getMaximumHoneyLevel(self) -> int
      :async:
   ...
   .. py:method:: setHoneyLevel(self, _0:int) -> None
      :async:
