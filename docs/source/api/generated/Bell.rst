...
Inheritance
------------
* pycraft.server.final.Bell
* :py:class:`pycraft.server.world.Bell`
...
Python Proxy to `org.bukkit.block.data.type.Bell <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Bell.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Bell(self, string_value=None, **named)
   :canonical: pycraft.server.final.Bell
   ...
   .. py:method:: getAttachment(self) -> :py:class:`Attachment`
      :async:
   ...
   .. py:method:: setAttachment(self, _0:Attachment) -> None
      :async:
