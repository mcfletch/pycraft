...
Inheritance
------------
* pycraft.server.final.Billboard
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.Display.Billboard <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Display/Billboard.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Billboard(self, key)
   :canonical: pycraft.server.final.Billboard
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Billboard`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Billboard`]
      :async:
      :classmethod:
