...
Python Proxy to `org.bukkit.entity.Blaze <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Blaze.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Blaze(self, **named)
   :canonical: pycraft.server.final.Blaze
