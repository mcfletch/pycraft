...
Inheritance
------------
* pycraft.server.final.BlockData
* :py:class:`pycraft.server.world.BlockData`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.block.data.BlockData <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/BlockData.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: BlockData(self, string_value=None, **named)
   :canonical: pycraft.server.final.BlockData
