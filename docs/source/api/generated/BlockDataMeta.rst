...
Inheritance
------------
* pycraft.server.final.BlockDataMeta
...
Python Proxy to `org.bukkit.inventory.meta.BlockDataMeta <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/meta/BlockDataMeta.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: BlockDataMeta(self, **named)
   :canonical: pycraft.server.final.BlockDataMeta
   ...
   .. py:method:: getBlockData(self, _0:Material) -> :py:class:`BlockData`
      :async:
   ...
   .. py:method:: hasBlockData(self) -> bool
      :async:
