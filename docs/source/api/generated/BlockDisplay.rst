...
Inheritance
------------
* pycraft.server.final.BlockDisplay
...
Python Proxy to `org.bukkit.entity.BlockDisplay <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/BlockDisplay.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: BlockDisplay(self, **named)
   :canonical: pycraft.server.final.BlockDisplay
   ...
   .. py:method:: getBlock(self) -> :py:class:`BlockData`
      :async:
   ...
   .. py:method:: setBlock(self, _0:BlockData) -> None
      :async:
