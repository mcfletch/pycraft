...
Inheritance
------------
* pycraft.server.final.BlockFace
* :py:class:`pycraft.server.world.BlockFace`
...
Python Proxy to `org.bukkit.block.BlockFace <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/BlockFace.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: BlockFace(self, key)
   :canonical: pycraft.server.final.BlockFace
   ...
   .. py:method:: getModX(self) -> int
      :async:


   .. py:method:: getModY(self) -> int
      :async:


   .. py:method:: getModZ(self) -> int
      :async:


   .. py:method:: getOppositeFace(self) -> :py:class:`BlockFace`
      :async:
   ...
   .. py:method:: isCartesian(self) -> bool
      :async:
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`BlockFace`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`BlockFace`]
      :async:
      :classmethod:
