...
Inheritance
------------
* pycraft.server.final.BlockStateMeta
...
Python Proxy to `org.bukkit.inventory.meta.BlockStateMeta <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/meta/BlockStateMeta.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: BlockStateMeta(self, **named)
   :canonical: pycraft.server.final.BlockStateMeta
   ...
   .. py:method:: getBlockState(self) -> :py:class:`BlockState`
      :async:
   ...
   .. py:method:: hasBlockState(self) -> bool
      :async:
   ...
   .. py:method:: setBlockState(self, _0:BlockState) -> None
      :async:
