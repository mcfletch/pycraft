...
Inheritance
------------
* pycraft.server.final.BlockSupport
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.block.BlockSupport <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/BlockSupport.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: BlockSupport(self, key)
   :canonical: pycraft.server.final.BlockSupport
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`BlockSupport`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`BlockSupport`]
      :async:
      :classmethod:
