...
Python Proxy to `org.bukkit.entity.Boat <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Boat.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Boat(self, **named)
   :canonical: pycraft.server.final.Boat
