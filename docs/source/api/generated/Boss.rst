...
Python Proxy to `org.bukkit.entity.Boss <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Boss.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Boss(self, **named)
   :canonical: pycraft.server.final.Boss
