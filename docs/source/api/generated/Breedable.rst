...
Inheritance
------------
* pycraft.server.final.Breedable
...
Python Proxy to `org.bukkit.entity.Breedable <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Breedable.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Breedable(self, **named)
   :canonical: pycraft.server.final.Breedable
