...
* :py:class:`pycraft.server.final.Sittable`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.Camel <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Camel.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Camel(self, **named)
   :canonical: pycraft.server.final.Camel
   ...
   .. py:method:: setDashing(self, _0:boolean) -> None
      :async:
