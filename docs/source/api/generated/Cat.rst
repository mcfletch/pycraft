...
Python Proxy to `org.bukkit.entity.Cat <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Cat.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Cat(self, **named)
   :canonical: pycraft.server.final.Cat
   ...
   .. py:method:: getCatType(self) -> :py:class:`Type`
      :async:
   ...
   .. py:method:: getCollarColor(self) -> :py:class:`DyeColor`
      :async:
   ...
   .. py:method:: isLyingDown(self) -> bool
      :async:
   ...
   .. py:method:: setCatType(self, _0:Type) -> None
      :async:


   .. py:method:: setCollarColor(self, _0:DyeColor) -> None
      :async:
   ...
   .. py:method:: setHeadUp(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setLyingDown(self, _0:boolean) -> None
      :async:
