...
Inheritance
------------
* pycraft.server.final.Category
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.potion.PotionEffectType.Category <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/potion/PotionEffectType/Category.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Category(self, key)
   :canonical: pycraft.server.final.Category
   ...
   .. py:method:: getColor(self) -> :py:class:`TextColor`
      :async:
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Category`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Category`]
      :async:
      :classmethod:
