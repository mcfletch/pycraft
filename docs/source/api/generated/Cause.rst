...
Inheritance
------------
* pycraft.server.final.Cause
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.event.player.PlayerKickEvent.Cause <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/event/player/PlayerKickEvent/Cause.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Cause(self, key)
   :canonical: pycraft.server.final.Cause
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Cause`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Cause`]
      :async:
      :classmethod:
