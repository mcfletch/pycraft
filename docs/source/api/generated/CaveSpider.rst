...
Inheritance
------------
* pycraft.server.final.CaveSpider
* :py:class:`pycraft.server.final.Spider`
...
Python Proxy to `org.bukkit.entity.CaveSpider <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/CaveSpider.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: CaveSpider(self, **named)
   :canonical: pycraft.server.final.CaveSpider
