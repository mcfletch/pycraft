...
Inheritance
------------
* pycraft.server.final.Chain
* :py:class:`pycraft.server.world.Chain`
* :py:class:`pycraft.server.final.Orientable`
...
Python Proxy to `org.bukkit.block.data.type.Chain <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Chain.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Chain(self, string_value=None, **named)
   :canonical: pycraft.server.final.Chain
