...
Inheritance
------------
* pycraft.server.final.Chest
* :py:class:`pycraft.server.world.Chest`
...
Python Proxy to `org.bukkit.block.data.type.Chest <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Chest.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Chest(self, string_value=None, **named)
   :canonical: pycraft.server.final.Chest
