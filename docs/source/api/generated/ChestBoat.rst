...
Inheritance
------------
* pycraft.server.final.ChestBoat
* :py:class:`pycraft.server.final.Boat`
...
Python Proxy to `org.bukkit.entity.ChestBoat <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/ChestBoat.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: ChestBoat(self, **named)
   :canonical: pycraft.server.final.ChestBoat
   ...
   .. py:method:: getBoatMaterial(self) -> :py:class:`Material`
      :async:


   .. py:method:: getBoatType(self) -> :py:class:`Type`
      :async:
   ...
   .. py:method:: getOccupiedDeceleration(self) -> float
      :async:
   ...
   .. py:method:: getStatus(self) -> :py:class:`Status`
      :async:
   ...
   .. py:method:: getUnoccupiedDeceleration(self) -> float
      :async:
   ...
   .. py:method:: getWoodType(self) -> :py:class:`TreeSpecies`
      :async:


   .. py:method:: getWorkOnLand(self) -> bool
      :async:
   ...
   .. py:method:: setBoatType(self, _0:Type) -> None
      :async:
   ...
   .. py:method:: setOccupiedDeceleration(self, _0:double) -> None
      :async:
   ...
   .. py:method:: setUnoccupiedDeceleration(self, _0:double) -> None
      :async:
   ...
   .. py:method:: setWoodType(self, _0:TreeSpecies) -> None
      :async:


   .. py:method:: setWorkOnLand(self, _0:boolean) -> None
      :async:
