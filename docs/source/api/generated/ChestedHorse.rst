...
Inheritance
------------
* pycraft.server.final.ChestedHorse
...
Python Proxy to `org.bukkit.entity.ChestedHorse <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/ChestedHorse.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: ChestedHorse(self, **named)
   :canonical: pycraft.server.final.ChestedHorse
