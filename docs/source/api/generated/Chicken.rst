...
Python Proxy to `org.bukkit.entity.Chicken <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Chicken.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Chicken(self, **named)
   :canonical: pycraft.server.final.Chicken
   ...
   .. py:method:: getEggLayTime(self) -> int
      :async:
   ...
   .. py:method:: isChickenJockey(self) -> bool
      :async:
   ...
   .. py:method:: setEggLayTime(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setIsChickenJockey(self, _0:boolean) -> None
      :async:
