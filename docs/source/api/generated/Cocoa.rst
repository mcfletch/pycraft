...
Inheritance
------------
* pycraft.server.final.Cocoa
* :py:class:`pycraft.server.world.Cocoa`
...
Python Proxy to `org.bukkit.block.data.type.Cocoa <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Cocoa.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Cocoa(self, string_value=None, **named)
   :canonical: pycraft.server.final.Cocoa
