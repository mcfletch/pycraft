...
Inheritance
------------
* pycraft.server.final.Cod
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.Cod <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Cod.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Cod(self, **named)
   :canonical: pycraft.server.final.Cod
