...
Inheritance
------------
* pycraft.server.final.Command
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.command.Command <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/command/Command.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Command(self, **named)
   :canonical: pycraft.server.final.Command
