...
Inheritance
------------
* pycraft.server.final.CommandBlock
* :py:class:`pycraft.server.world.CommandBlock`
...
Python Proxy to `org.bukkit.block.data.type.CommandBlock <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/CommandBlock.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: CommandBlock(self, string_value=None, **named)
   :canonical: pycraft.server.final.CommandBlock
   ...
   .. py:method:: isConditional(self) -> bool
      :async:
   ...
   .. py:method:: setConditional(self, _0:boolean) -> None
      :async:
