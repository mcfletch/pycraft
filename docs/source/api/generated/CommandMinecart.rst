...
Inheritance
------------
* pycraft.server.final.CommandMinecart
...
Python Proxy to `org.bukkit.entity.minecart.CommandMinecart <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/minecart/CommandMinecart.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: CommandMinecart(self, **named)
   :canonical: pycraft.server.final.CommandMinecart
   ...
   .. py:method:: getSuccessCount(self) -> int
      :async:
   ...
   .. py:method:: lastOutput

       .. py:method:: lastOutput(self) -> :py:class:`Component`
          :async:
          :noindex:

       .. py:method:: lastOutput(self, _0:Component) -> None
          :async:
          :noindex:
   ...
   .. py:method:: setCommand(self, _0:String) -> None
      :async:
   ...
   .. py:method:: setName(self, _0:String) -> None
      :async:
   ...
   .. py:method:: setSuccessCount(self, _0:int) -> None
      :async:
