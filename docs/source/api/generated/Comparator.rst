...
Inheritance
------------
* pycraft.server.final.Comparator
* :py:class:`pycraft.server.world.Comparator`
...
Python Proxy to `org.bukkit.block.data.type.Comparator <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Comparator.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Comparator(self, string_value=None, **named)
   :canonical: pycraft.server.final.Comparator
