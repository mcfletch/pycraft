...
Inheritance
------------
* pycraft.server.final.CompassMeta
...
Python Proxy to `org.bukkit.inventory.meta.CompassMeta <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/meta/CompassMeta.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: CompassMeta(self, **named)
   :canonical: pycraft.server.final.CompassMeta
   ...
   .. py:method:: getLodestone(self) -> :py:class:`Location`
      :async:
   ...
   .. py:method:: hasLodestone(self) -> bool
      :async:
   ...
   .. py:method:: isLodestoneTracked(self) -> bool
      :async:
   ...
   .. py:method:: setLodestone(self, _0:Location) -> None
      :async:


   .. py:method:: setLodestoneTracked(self, _0:boolean) -> None
      :async:
