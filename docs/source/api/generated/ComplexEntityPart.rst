...
Inheritance
------------
* pycraft.server.final.ComplexEntityPart
...
Python Proxy to `org.bukkit.entity.ComplexEntityPart <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/ComplexEntityPart.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: ComplexEntityPart(self, **named)
   :canonical: pycraft.server.final.ComplexEntityPart
