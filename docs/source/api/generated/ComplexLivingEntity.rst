...
Inheritance
------------
* pycraft.server.final.ComplexLivingEntity
...
Python Proxy to `org.bukkit.entity.ComplexLivingEntity <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/ComplexLivingEntity.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: ComplexLivingEntity(self, **named)
   :canonical: pycraft.server.final.ComplexLivingEntity
