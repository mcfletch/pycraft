...
Inheritance
------------
* pycraft.server.final.Connection
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.block.data.type.RedstoneWire.Connection <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/RedstoneWire/Connection.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Connection(self, key)
   :canonical: pycraft.server.final.Connection
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Connection`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Connection`]
      :async:
      :classmethod:
