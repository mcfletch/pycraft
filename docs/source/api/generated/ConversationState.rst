...
Inheritance
------------
* pycraft.server.final.ConversationState
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.conversations.Conversation.ConversationState <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/conversations/Conversation/ConversationState.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: ConversationState(self, key)
   :canonical: pycraft.server.final.ConversationState
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`ConversationState`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`ConversationState`]
      :async:
      :classmethod:
