...
Inheritance
------------
* pycraft.server.final.CoralWallFan
* :py:class:`pycraft.server.world.CoralWallFan`
...
Python Proxy to `org.bukkit.block.data.type.CoralWallFan <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/CoralWallFan.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: CoralWallFan(self, string_value=None, **named)
   :canonical: pycraft.server.final.CoralWallFan
