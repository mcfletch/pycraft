...
Python Proxy to `org.bukkit.entity.Cow <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Cow.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Cow(self, **named)
   :canonical: pycraft.server.final.Cow
