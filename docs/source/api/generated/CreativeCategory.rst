...
Inheritance
------------
* pycraft.server.final.CreativeCategory
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.inventory.CreativeCategory <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/CreativeCategory.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: CreativeCategory(self, key)
   :canonical: pycraft.server.final.CreativeCategory
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`CreativeCategory`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`CreativeCategory`]
      :async:
      :classmethod:
