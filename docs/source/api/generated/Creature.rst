...
Python Proxy to `org.bukkit.entity.Creature <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Creature.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Creature(self, **named)
   :canonical: pycraft.server.final.Creature
