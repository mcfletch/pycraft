...
Python Proxy to `org.bukkit.entity.Creeper <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Creeper.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Creeper(self, **named)
   :canonical: pycraft.server.final.Creeper
   ...
   .. py:method:: getExplosionRadius(self) -> int
      :async:
   ...
   .. py:method:: getMaxFuseTicks(self) -> int
      :async:
   ...
   .. py:method:: setExplosionRadius(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setIgnited(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setMaxFuseTicks(self, _0:int) -> None
      :async:
