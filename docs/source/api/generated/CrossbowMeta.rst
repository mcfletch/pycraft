...
Inheritance
------------
* pycraft.server.final.CrossbowMeta
...
Python Proxy to `org.bukkit.inventory.meta.CrossbowMeta <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/meta/CrossbowMeta.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: CrossbowMeta(self, **named)
   :canonical: pycraft.server.final.CrossbowMeta
   ...
   .. py:method:: addChargedProjectile(self, _0:ItemStack) -> None
      :async:
   ...
   .. py:method:: getChargedProjectiles(self) -> typing.List[:py:class:`ItemStack`]
      :async:
   ...
   .. py:method:: hasChargedProjectiles(self) -> bool
      :async:
   ...
   .. py:method:: setChargedProjectiles(self, _0:List) -> None
      :async:
