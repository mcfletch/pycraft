...
Inheritance
------------
* pycraft.server.final.DamageCause
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.event.entity.EntityDamageEvent.DamageCause <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/event/entity/EntityDamageEvent/DamageCause.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: DamageCause(self, key)
   :canonical: pycraft.server.final.DamageCause
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`DamageCause`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`DamageCause`]
      :async:
      :classmethod:
