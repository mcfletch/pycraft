...
Inheritance
------------
* pycraft.server.final.DamageModifier
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.event.entity.EntityDamageEvent.DamageModifier <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/event/entity/EntityDamageEvent/DamageModifier.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: DamageModifier(self, key)
   :canonical: pycraft.server.final.DamageModifier
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`DamageModifier`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`DamageModifier`]
      :async:
      :classmethod:
