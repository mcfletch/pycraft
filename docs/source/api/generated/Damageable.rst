...
Inheritance
------------
* pycraft.server.final.Damageable
...
Python Proxy to `org.bukkit.entity.Damageable <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Damageable.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Damageable(self, **named)
   :canonical: pycraft.server.final.Damageable
