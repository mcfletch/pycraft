...
Inheritance
------------
* pycraft.server.final.DaylightDetector
* :py:class:`pycraft.server.world.DaylightDetector`
...
Python Proxy to `org.bukkit.block.data.type.DaylightDetector <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/DaylightDetector.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: DaylightDetector(self, string_value=None, **named)
   :canonical: pycraft.server.final.DaylightDetector
   ...
   .. py:method:: isInverted(self) -> bool
      :async:
   ...
   .. py:method:: setInverted(self, _0:boolean) -> None
      :async:
