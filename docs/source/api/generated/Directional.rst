...
Inheritance
------------
* pycraft.server.final.Directional
* :py:class:`pycraft.server.final.BlockData`
* :py:class:`pycraft.server.world.BlockData`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.block.data.Directional <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/Directional.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Directional(self, string_value=None, **named)
   :canonical: pycraft.server.final.Directional
