...
Inheritance
------------
* pycraft.server.final.Dispenser
* :py:class:`pycraft.server.world.Dispenser`
...
Python Proxy to `org.bukkit.block.data.type.Dispenser <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Dispenser.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Dispenser(self, string_value=None, **named)
   :canonical: pycraft.server.final.Dispenser
   ...
   .. py:method:: isTriggered(self) -> bool
      :async:
   ...
   .. py:method:: setTriggered(self, _0:boolean) -> None
      :async:
