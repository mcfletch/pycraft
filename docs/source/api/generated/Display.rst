...
Python Proxy to `org.bukkit.entity.Display <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Display.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Display(self, **named)
   :canonical: pycraft.server.final.Display
