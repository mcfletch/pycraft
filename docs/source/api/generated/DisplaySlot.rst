...
Inheritance
------------
* pycraft.server.final.DisplaySlot
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.scoreboard.DisplaySlot <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/scoreboard/DisplaySlot.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: DisplaySlot(self, key)
   :canonical: pycraft.server.final.DisplaySlot
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`DisplaySlot`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`DisplaySlot`]
      :async:
      :classmethod:
