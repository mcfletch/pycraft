...
Python Proxy to `org.bukkit.entity.Dolphin <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Dolphin.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Dolphin(self, **named)
   :canonical: pycraft.server.final.Dolphin
   ...
   .. py:method:: getMoistness(self) -> int
      :async:
   ...
   .. py:method:: getTreasureLocation(self) -> :py:class:`Location`
      :async:
   ...
   .. py:method:: setHasFish(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setMoistness(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setTreasureLocation(self, _0:Location) -> None
      :async:
