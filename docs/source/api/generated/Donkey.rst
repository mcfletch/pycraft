...
Python Proxy to `org.bukkit.entity.Donkey <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Donkey.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Donkey(self, **named)
   :canonical: pycraft.server.final.Donkey
