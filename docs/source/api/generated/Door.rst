...
Inheritance
------------
* pycraft.server.final.Door
* :py:class:`pycraft.server.world.Door`
* :py:class:`pycraft.server.final.Bisected`
* :py:class:`pycraft.server.final.Directional`
* :py:class:`pycraft.server.final.Openable`
...
Python Proxy to `org.bukkit.block.data.type.Door <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Door.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Door(self, string_value=None, **named)
   :canonical: pycraft.server.final.Door
   ...
   .. py:method:: getHalf(self) -> :py:class:`Half`
      :async:


   .. py:method:: getHinge(self) -> :py:class:`Hinge`
      :async:
   ...
   .. py:method:: setHalf(self, _0:Half) -> None
      :async:


   .. py:method:: setHinge(self, _0:Hinge) -> None
      :async:


   .. py:method:: setOpen(self, _0:boolean) -> None
      :async:
