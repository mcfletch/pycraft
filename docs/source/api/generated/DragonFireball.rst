...
Inheritance
------------
* pycraft.server.final.DragonFireball
...
Python Proxy to `org.bukkit.entity.DragonFireball <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/DragonFireball.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: DragonFireball(self, **named)
   :canonical: pycraft.server.final.DragonFireball
