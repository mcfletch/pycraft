...
Python Proxy to `org.bukkit.entity.Drowned <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Drowned.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Drowned(self, **named)
   :canonical: pycraft.server.final.Drowned
