...
Inheritance
------------
* pycraft.server.final.Effect
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.Effect <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/Effect.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Effect(self, key)
   :canonical: pycraft.server.final.Effect
   ...
   .. py:method:: getById(cls, _0:int) -> :py:class:`Effect`
      :async:
      :classmethod:
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Effect`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Effect`]
      :async:
      :classmethod:
