...
Python Proxy to `org.bukkit.entity.Egg <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Egg.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Egg(self, **named)
   :canonical: pycraft.server.final.Egg
