...
Inheritance
------------
* pycraft.server.final.ElderGuardian
* :py:class:`pycraft.server.final.Guardian`
...
Python Proxy to `org.bukkit.entity.ElderGuardian <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/ElderGuardian.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: ElderGuardian(self, **named)
   :canonical: pycraft.server.final.ElderGuardian
   ...
   .. py:method:: getLaserDuration(self) -> int
      :async:


   .. py:method:: getLaserTicks(self) -> int
      :async:
   ...
   .. py:method:: setElder(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setLaser(self, _0:boolean) -> bool
      :async:


   .. py:method:: setLaserTicks(self, _0:int) -> None
      :async:
