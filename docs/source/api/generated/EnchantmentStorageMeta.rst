...
Inheritance
------------
* pycraft.server.final.EnchantmentStorageMeta
...
Python Proxy to `org.bukkit.inventory.meta.EnchantmentStorageMeta <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/meta/EnchantmentStorageMeta.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: EnchantmentStorageMeta(self, **named)
   :canonical: pycraft.server.final.EnchantmentStorageMeta
   ...
   .. py:method:: addStoredEnchant(self, _0:Enchantment, _1:int, _2:boolean) -> bool
      :async:
   ...
   .. py:method:: getStoredEnchantLevel(self, _0:Enchantment) -> int
      :async:


   .. py:method:: getStoredEnchants(self) -> :py:class:`Map`
      :async:
   ...
   .. py:method:: hasConflictingStoredEnchant(self, _0:Enchantment) -> bool
      :async:
   ...
   .. py:method:: hasStoredEnchant(self, _0:Enchantment) -> bool
      :async:


   .. py:method:: hasStoredEnchants(self) -> bool
      :async:
   ...
   .. py:method:: removeStoredEnchant(self, _0:Enchantment) -> bool
      :async:
