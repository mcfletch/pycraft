...
Inheritance
------------
* pycraft.server.final.EnchantmentTarget
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.enchantments.EnchantmentTarget <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/enchantments/EnchantmentTarget.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: EnchantmentTarget(self, key)
   :canonical: pycraft.server.final.EnchantmentTarget
   ...
   .. py:method:: includes
       ...
       .. py:method:: includes(self, _0:ItemStack) -> bool
          :async:
          :noindex:

       .. py:method:: includes(self, _0:Material) -> bool
          :async:
          :noindex:
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`EnchantmentTarget`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`EnchantmentTarget`]
      :async:
      :classmethod:
