...
Inheritance
------------
* pycraft.server.final.EndPortalFrame
* :py:class:`pycraft.server.world.EndPortalFrame`
...
Python Proxy to `org.bukkit.block.data.type.EndPortalFrame <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/EndPortalFrame.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: EndPortalFrame(self, string_value=None, **named)
   :canonical: pycraft.server.final.EndPortalFrame
   ...
   .. py:method:: setEye(self, _0:boolean) -> None
      :async:
