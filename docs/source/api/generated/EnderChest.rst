...
Inheritance
------------
* pycraft.server.final.EnderChest
* :py:class:`pycraft.server.world.EnderChest`
...
Python Proxy to `org.bukkit.block.data.type.EnderChest <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/EnderChest.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: EnderChest(self, string_value=None, **named)
   :canonical: pycraft.server.final.EnderChest
