...
Inheritance
------------
* pycraft.server.final.EnderCrystal
...
Python Proxy to `org.bukkit.entity.EnderCrystal <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/EnderCrystal.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: EnderCrystal(self, **named)
   :canonical: pycraft.server.final.EnderCrystal
   ...
   .. py:method:: getBeamTarget(self) -> :py:class:`Location`
      :async:
   ...
   .. py:method:: isShowingBottom(self) -> bool
      :async:
   ...
   .. py:method:: setBeamTarget(self, _0:Location) -> None
      :async:
   ...
   .. py:method:: setShowingBottom(self, _0:boolean) -> None
      :async:
