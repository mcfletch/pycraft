...
Inheritance
------------
* pycraft.server.final.EnderDragon
* :py:class:`pycraft.server.final.ComplexLivingEntity`
...
Python Proxy to `org.bukkit.entity.EnderDragon <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/EnderDragon.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: EnderDragon(self, **named)
   :canonical: pycraft.server.final.EnderDragon
   ...
   .. py:method:: getDeathAnimationTicks(self) -> int
      :async:
   ...
   .. py:method:: getDragonBattle(self) -> :py:class:`DragonBattle`
      :async:
   ...
   .. py:method:: getParts(self) -> typing.List[:py:class:`ComplexEntityPart`]
      :async:
   ...
   .. py:method:: getPhase(self) -> :py:class:`Phase`
      :async:
   ...
   .. py:method:: getPodium(self) -> :py:class:`Location`
      :async:
   ...
   .. py:method:: setPhase(self, _0:Phase) -> None
      :async:


   .. py:method:: setPodium(self, _0:Location) -> None
      :async:
