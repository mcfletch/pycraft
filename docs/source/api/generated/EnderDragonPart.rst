...
Inheritance
------------
* pycraft.server.final.EnderDragonPart
* :py:class:`pycraft.server.final.ComplexEntityPart`
...
Python Proxy to `org.bukkit.entity.EnderDragonPart <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/EnderDragonPart.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: EnderDragonPart(self, **named)
   :canonical: pycraft.server.final.EnderDragonPart
   ...
   .. py:method:: getParent
       ...
       .. py:method:: getParent(self) -> :py:class:`EnderDragon`
          :async:
          :noindex:

       .. py:method:: getParent(self) -> :py:class:`ComplexLivingEntity`
          :async:
          :noindex:
