...
Inheritance
------------
* pycraft.server.final.EnderPearl
...
Python Proxy to `org.bukkit.entity.EnderPearl <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/EnderPearl.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: EnderPearl(self, **named)
   :canonical: pycraft.server.final.EnderPearl
