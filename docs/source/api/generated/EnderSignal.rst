...
Inheritance
------------
* pycraft.server.final.EnderSignal
...
Python Proxy to `org.bukkit.entity.EnderSignal <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/EnderSignal.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: EnderSignal(self, **named)
   :canonical: pycraft.server.final.EnderSignal
   ...
   .. py:method:: getDespawnTimer(self) -> int
      :async:
   ...
   .. py:method:: getTargetLocation(self) -> :py:class:`Location`
      :async:
   ...
   .. py:method:: setDespawnTimer(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setTargetLocation

       .. py:method:: setTargetLocation(self, _0:Location) -> None
          :async:
          :noindex:

       .. py:method:: setTargetLocation(self, _0:Location, _1:boolean) -> None
          :async:
          :noindex:
