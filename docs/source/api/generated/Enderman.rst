...
Python Proxy to `org.bukkit.entity.Enderman <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Enderman.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Enderman(self, **named)
   :canonical: pycraft.server.final.Enderman
   ...
   .. py:method:: getCarriedBlock(self) -> :py:class:`BlockData`
      :async:


   .. py:method:: getCarriedMaterial(self) -> :py:class:`MaterialData`
      :async:
   ...
   .. py:method:: hasBeenStaredAt(self) -> bool
      :async:
   ...
   .. py:method:: setCarriedBlock(self, _0:BlockData) -> None
      :async:


   .. py:method:: setCarriedMaterial(self, _0:MaterialData) -> None
      :async:
   ...
   .. py:method:: setHasBeenStaredAt(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: teleportRandomly(self) -> bool
      :async:
