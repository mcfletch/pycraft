...
Inheritance
------------
* pycraft.server.final.Endermite
...
Python Proxy to `org.bukkit.entity.Endermite <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Endermite.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Endermite(self, **named)
   :canonical: pycraft.server.final.Endermite
   ...
   .. py:method:: isPlayerSpawned(self) -> bool
      :async:
   ...
   .. py:method:: setPlayerSpawned(self, _0:boolean) -> None
      :async:
