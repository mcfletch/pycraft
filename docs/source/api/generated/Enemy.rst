...
Python Proxy to `org.bukkit.entity.Enemy <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Enemy.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Enemy(self, **named)
   :canonical: pycraft.server.final.Enemy
