...
Python Proxy to `org.bukkit.entity.Entity <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Entity.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Entity(self, **named)
   :canonical: pycraft.server.final.Entity
