...
Inheritance
------------
* pycraft.server.final.EntityCategory
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.EntityCategory <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/EntityCategory.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: EntityCategory(self, key)
   :canonical: pycraft.server.final.EntityCategory
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`EntityCategory`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`EntityCategory`]
      :async:
      :classmethod:
