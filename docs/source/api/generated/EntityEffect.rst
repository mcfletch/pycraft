...
Inheritance
------------
* pycraft.server.final.EntityEffect
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.EntityEffect <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/EntityEffect.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: EntityEffect(self, key)
   :canonical: pycraft.server.final.EntityEffect
   ...
   .. py:method:: getApplicable(self) -> :py:class:`Class`
      :async:
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`EntityEffect`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`EntityEffect`]
      :async:
      :classmethod:
