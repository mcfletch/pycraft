...
Inheritance
------------
* pycraft.server.final.Environment
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.World.Environment <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/World/Environment.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Environment(self, key)
   :canonical: pycraft.server.final.Environment
   ...
   .. py:method:: getEnvironment(cls, _0:int) -> :py:class:`Environment`
      :async:
      :classmethod:
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Environment`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Environment`]
      :async:
      :classmethod:
