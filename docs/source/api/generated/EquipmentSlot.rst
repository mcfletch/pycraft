...
Inheritance
------------
* pycraft.server.final.EquipmentSlot
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.inventory.EquipmentSlot <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/EquipmentSlot.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: EquipmentSlot(self, key)
   :canonical: pycraft.server.final.EquipmentSlot
   ...
   .. py:method:: isArmor(self) -> bool
      :async:


   .. py:method:: isHand(self) -> bool
      :async:
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`EquipmentSlot`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`EquipmentSlot`]
      :async:
      :classmethod:
