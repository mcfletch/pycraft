...
Inheritance
------------
* pycraft.server.final.EventPriority
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.event.EventPriority <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/event/EventPriority.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: EventPriority(self, key)
   :canonical: pycraft.server.final.EventPriority
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`EventPriority`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`EventPriority`]
      :async:
      :classmethod:
