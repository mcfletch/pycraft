...
Inheritance
------------
* pycraft.server.final.Evoker
* :py:class:`pycraft.server.final.Spellcaster`
* :py:class:`pycraft.server.final.Illager`
...
Python Proxy to `org.bukkit.entity.Evoker <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Evoker.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Evoker(self, **named)
   :canonical: pycraft.server.final.Evoker
   ...
   .. py:method:: getCurrentSpell(self) -> :py:class:`Spell`
      :async:
   ...
   .. py:method:: getSpell(self) -> :py:class:`Spell`
      :async:
   ...
   .. py:method:: getWololoTarget(self) -> :py:class:`Sheep`
      :async:
   ...
   .. py:method:: setCurrentSpell(self, _0:Spell) -> None
      :async:
   ...
   .. py:method:: setSpell(self, _0:Spell) -> None
      :async:
   ...
   .. py:method:: setWololoTarget(self, _0:Sheep) -> None
      :async:
