...
Inheritance
------------
* pycraft.server.final.EvokerFangs
...
Python Proxy to `org.bukkit.entity.EvokerFangs <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/EvokerFangs.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: EvokerFangs(self, **named)
   :canonical: pycraft.server.final.EvokerFangs
   ...
   .. py:method:: getOwner(self) -> :py:class:`LivingEntity`
      :async:
   ...
   .. py:method:: setOwner(self, _0:LivingEntity) -> None
      :async:
