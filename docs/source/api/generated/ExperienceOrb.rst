...
Inheritance
------------
* pycraft.server.final.ExperienceOrb
...
Python Proxy to `org.bukkit.entity.ExperienceOrb <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/ExperienceOrb.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: ExperienceOrb(self, **named)
   :canonical: pycraft.server.final.ExperienceOrb
   ...
   .. py:method:: getExperience(self) -> int
      :async:
   ...
   .. py:method:: getSourceEntityId(self) -> uuid.UUID
      :async:
   ...
   .. py:method:: getSpawnReason(self) -> :py:class:`SpawnReason`
      :async:
   ...
   .. py:method:: getTriggerEntityId(self) -> uuid.UUID
      :async:
   ...
   .. py:method:: isFromBottle(self) -> bool
      :async:
   ...
   .. py:method:: setExperience(self, _0:int) -> None
      :async:
