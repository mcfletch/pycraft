...
Inheritance
------------
* pycraft.server.final.Explosive
...
Python Proxy to `org.bukkit.entity.Explosive <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Explosive.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Explosive(self, **named)
   :canonical: pycraft.server.final.Explosive
