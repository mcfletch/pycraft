...
Inheritance
------------
* pycraft.server.final.ExplosiveMinecart
...
Python Proxy to `org.bukkit.entity.minecart.ExplosiveMinecart <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/minecart/ExplosiveMinecart.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: ExplosiveMinecart(self, **named)
   :canonical: pycraft.server.final.ExplosiveMinecart
   ...
   .. py:method:: explode
       ...
       .. py:method:: explode(self) -> None
          :async:
          :noindex:

       .. py:method:: explode(self, _0:double) -> None
          :async:
          :noindex:
   ...
   .. py:method:: getFuseTicks(self) -> int
      :async:
   ...
   .. py:method:: setFuseTicks(self, _0:int) -> None
      :async:
