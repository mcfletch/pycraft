...
Inheritance
------------
* pycraft.server.final.Face
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.block.data.type.Switch.Face <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Switch/Face.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Face(self, key)
   :canonical: pycraft.server.final.Face
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Face`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Face`]
      :async:
      :classmethod:
