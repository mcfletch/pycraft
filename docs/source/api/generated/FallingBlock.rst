...
Inheritance
------------
* pycraft.server.final.FallingBlock
...
Python Proxy to `org.bukkit.entity.FallingBlock <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/FallingBlock.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: FallingBlock(self, **named)
   :canonical: pycraft.server.final.FallingBlock
   ...
   .. py:method:: canHurtEntities(self) -> bool
      :async:
   ...
   .. py:method:: doesAutoExpire(self) -> bool
      :async:
   ...
   .. py:method:: getDamagePerBlock(self) -> float
      :async:


   .. py:method:: getDropItem(self) -> bool
      :async:
   ...
   .. py:method:: getMaxDamage(self) -> int
      :async:
   ...
   .. py:method:: getSourceLoc(self) -> :py:class:`Location`
      :async:
   ...
   .. py:method:: setDamagePerBlock(self, _0:float) -> None
      :async:


   .. py:method:: setDropItem(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setHurtEntities(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setMaxDamage(self, _0:int) -> None
      :async:
   ...
   .. py:method:: shouldAutoExpire(self, _0:boolean) -> None
      :async:
