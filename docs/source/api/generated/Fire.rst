...
Inheritance
------------
* pycraft.server.final.Fire
* :py:class:`pycraft.server.world.Fire`
...
Python Proxy to `org.bukkit.block.data.type.Fire <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Fire.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Fire(self, string_value=None, **named)
   :canonical: pycraft.server.final.Fire
