...
Python Proxy to `org.bukkit.entity.Fireball <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Fireball.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Fireball(self, **named)
   :canonical: pycraft.server.final.Fireball
