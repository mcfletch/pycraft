...
Python Proxy to `org.bukkit.entity.Firework <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Firework.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Firework(self, **named)
   :canonical: pycraft.server.final.Firework
   ...
   .. py:method:: getAttachedTo(self) -> :py:class:`LivingEntity`
      :async:


   .. py:method:: getBoostedEntity(self) -> :py:class:`LivingEntity`
      :async:
   ...
   .. py:method:: getFireworkMeta(self) -> :py:class:`FireworkMeta`
      :async:
   ...
   .. py:method:: getSpawningEntity(self) -> uuid.UUID
      :async:
   ...
   .. py:method:: getTicksFlown(self) -> int
      :async:
   ...
   .. py:method:: getTicksToDetonate(self) -> int
      :async:
   ...
   .. py:method:: isDetonated(self) -> bool
      :async:
   ...
   .. py:method:: isShotAtAngle(self) -> bool
      :async:
   ...
   .. py:method:: setAttachedTo(self, _0:LivingEntity) -> bool
      :async:
   ...
   .. py:method:: setFireworkMeta(self, _0:FireworkMeta) -> None
      :async:
   ...
   .. py:method:: setLife(self, _0:int) -> bool
      :async:


   .. py:method:: setMaxLife(self, _0:int) -> bool
      :async:
   ...
   .. py:method:: setShotAtAngle(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setTicksFlown(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setTicksToDetonate(self, _0:int) -> None
      :async:
