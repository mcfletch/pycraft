...
Inheritance
------------
* pycraft.server.final.FireworkEffectMeta
...
Python Proxy to `org.bukkit.inventory.meta.FireworkEffectMeta <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/meta/FireworkEffectMeta.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: FireworkEffectMeta(self, **named)
   :canonical: pycraft.server.final.FireworkEffectMeta
   ...
   .. py:method:: getEffect(self) -> :py:class:`FireworkEffect`
      :async:
   ...
   .. py:method:: setEffect(self, _0:FireworkEffect) -> None
      :async:
