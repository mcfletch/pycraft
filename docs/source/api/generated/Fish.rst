...
Python Proxy to `org.bukkit.entity.Fish <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Fish.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Fish(self, **named)
   :canonical: pycraft.server.final.Fish
