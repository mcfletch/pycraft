...
Python Proxy to `org.bukkit.entity.FishHook <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/FishHook.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: FishHook(self, **named)
   :canonical: pycraft.server.final.FishHook
   ...
   .. py:method:: getApplyLure(self) -> bool
      :async:


   .. py:method:: getBiteChance(self) -> float
      :async:
   ...
   .. py:method:: getHookedEntity(self) -> :py:class:`Entity`
      :async:
   ...
   .. py:method:: getMinWaitTime(self) -> int
      :async:
   ...
   .. py:method:: getState(self) -> :py:class:`HookState`
      :async:
   ...
   .. py:method:: isInOpenWater(self) -> bool
      :async:
   ...
   .. py:method:: pullHookedEntity(self) -> bool
      :async:
   ...
   .. py:method:: setApplyLure(self, _0:boolean) -> None
      :async:


   .. py:method:: setBiteChance(self, _0:double) -> None
      :async:
   ...
   .. py:method:: setHookedEntity(self, _0:Entity) -> None
      :async:
   ...
   .. py:method:: setMinWaitTime(self, _0:int) -> None
      :async:
