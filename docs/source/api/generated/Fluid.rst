...
Inheritance
------------
* pycraft.server.final.Fluid
* :py:class:`pycraft.server.world.Fluid`
...
Python Proxy to `org.bukkit.Fluid <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/Fluid.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Fluid(self, key)
   :canonical: pycraft.server.final.Fluid
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Fluid`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Fluid`]
      :async:
      :classmethod:
