...
Inheritance
------------
* pycraft.server.final.FluidCollisionMode
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.FluidCollisionMode <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/FluidCollisionMode.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: FluidCollisionMode(self, key)
   :canonical: pycraft.server.final.FluidCollisionMode
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`FluidCollisionMode`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`FluidCollisionMode`]
      :async:
      :classmethod:
