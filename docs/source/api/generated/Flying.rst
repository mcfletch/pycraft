...
Python Proxy to `org.bukkit.entity.Flying <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Flying.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Flying(self, **named)
   :canonical: pycraft.server.final.Flying
