...
Python Proxy to `org.bukkit.entity.Fox <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Fox.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Fox(self, **named)
   :canonical: pycraft.server.final.Fox
   ...
   .. py:method:: getFirstTrustedPlayer(self) -> :py:class:`AnimalTamer`
      :async:


   .. py:method:: getFoxType(self) -> :py:class:`Type`
      :async:
   ...
   .. py:method:: getSecondTrustedPlayer(self) -> :py:class:`AnimalTamer`
      :async:
   ...
   .. py:method:: isCrouching(self) -> bool
      :async:
   ...
   .. py:method:: isDefending(self) -> bool
      :async:
   ...
   .. py:method:: isFaceplanted(self) -> bool
      :async:
   ...
   .. py:method:: isInterested(self) -> bool
      :async:
   ...
   .. py:method:: setCrouching(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setDefending(self, _0:boolean) -> None
      :async:


   .. py:method:: setFaceplanted(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setFirstTrustedPlayer(self, _0:AnimalTamer) -> None
      :async:


   .. py:method:: setFoxType(self, _0:Type) -> None
      :async:
   ...
   .. py:method:: setInterested(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setLeaping(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setSecondTrustedPlayer(self, _0:AnimalTamer) -> None
      :async:
   ...
   .. py:method:: setSleeping(self, _0:boolean) -> None
      :async:
