...
Python Proxy to `org.bukkit.entity.Frog <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Frog.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Frog(self, **named)
   :canonical: pycraft.server.final.Frog
   ...
   .. py:method:: getTongueTarget(self) -> :py:class:`Entity`
      :async:
   ...
   .. py:method:: setTongueTarget(self, _0:Entity) -> None
      :async:
