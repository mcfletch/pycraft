...
Inheritance
------------
* pycraft.server.final.Furnace
* :py:class:`pycraft.server.world.Furnace`
...
Python Proxy to `org.bukkit.block.data.type.Furnace <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Furnace.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Furnace(self, string_value=None, **named)
   :canonical: pycraft.server.final.Furnace
