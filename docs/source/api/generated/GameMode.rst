...
Inheritance
------------
* pycraft.server.final.GameMode
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.GameMode <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/GameMode.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: GameMode(self, key)
   :canonical: pycraft.server.final.GameMode
   ...
   .. py:method:: getByValue(cls, _0:int) -> :py:class:`GameMode`
      :async:
      :classmethod:
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`GameMode`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`GameMode`]
      :async:
      :classmethod:
