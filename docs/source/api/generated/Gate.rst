...
Inheritance
------------
* pycraft.server.final.Gate
* :py:class:`pycraft.server.world.Gate`
...
Python Proxy to `org.bukkit.block.data.type.Gate <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Gate.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Gate(self, string_value=None, **named)
   :canonical: pycraft.server.final.Gate
   ...
   .. py:method:: setInWall(self, _0:boolean) -> None
      :async:
