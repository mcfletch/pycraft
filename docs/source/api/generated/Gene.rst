...
Inheritance
------------
* pycraft.server.final.Gene
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.Panda.Gene <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Panda/Gene.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Gene(self, key)
   :canonical: pycraft.server.final.Gene
   ...
   .. py:method:: isRecessive(self) -> bool
      :async:
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Gene`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Gene`]
      :async:
      :classmethod:
