...
Inheritance
------------
* pycraft.server.final.Generation
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.inventory.meta.BookMeta.Generation <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/meta/BookMeta/Generation.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Generation(self, key)
   :canonical: pycraft.server.final.Generation
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Generation`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Generation`]
      :async:
      :classmethod:
