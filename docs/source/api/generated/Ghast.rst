...
Python Proxy to `org.bukkit.entity.Ghast <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Ghast.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Ghast(self, **named)
   :canonical: pycraft.server.final.Ghast
   ...
   .. py:method:: getExplosionPower(self) -> int
      :async:
   ...
   .. py:method:: setExplosionPower(self, _0:int) -> None
      :async:
