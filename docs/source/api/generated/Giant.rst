...
Python Proxy to `org.bukkit.entity.Giant <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Giant.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Giant(self, **named)
   :canonical: pycraft.server.final.Giant
