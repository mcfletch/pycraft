...
Inheritance
------------
* pycraft.server.final.GlassPane
* :py:class:`pycraft.server.world.GlassPane`
...
Python Proxy to `org.bukkit.block.data.type.GlassPane <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/GlassPane.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: GlassPane(self, string_value=None, **named)
   :canonical: pycraft.server.final.GlassPane
