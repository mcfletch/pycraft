...
Inheritance
------------
* pycraft.server.final.GlowSquid
* :py:class:`pycraft.server.final.Squid`
...
Python Proxy to `org.bukkit.entity.GlowSquid <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/GlowSquid.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: GlowSquid(self, **named)
   :canonical: pycraft.server.final.GlowSquid
   ...
   .. py:method:: getDarkTicksRemaining(self) -> int
      :async:
   ...
   .. py:method:: setDarkTicksRemaining(self, _0:int) -> None
      :async:
