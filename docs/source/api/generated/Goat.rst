...
Python Proxy to `org.bukkit.entity.Goat <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Goat.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Goat(self, **named)
   :canonical: pycraft.server.final.Goat
   ...
   .. py:method:: hasLeftHorn(self) -> bool
      :async:
   ...
   .. py:method:: hasRightHorn(self) -> bool
      :async:
   ...
   .. py:method:: isScreaming(self) -> bool
      :async:
   ...
   .. py:method:: ram(self, _0:LivingEntity) -> None
      :async:
   ...
   .. py:method:: setLeftHorn(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setRightHorn(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setScreaming(self, _0:boolean) -> None
      :async:
