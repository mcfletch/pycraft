...
Python Proxy to `org.bukkit.entity.Golem <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Golem.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Golem(self, **named)
   :canonical: pycraft.server.final.Golem
