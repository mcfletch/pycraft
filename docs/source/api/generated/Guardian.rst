...
Python Proxy to `org.bukkit.entity.Guardian <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Guardian.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Guardian(self, **named)
   :canonical: pycraft.server.final.Guardian
