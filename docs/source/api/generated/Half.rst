...
Inheritance
------------
* pycraft.server.final.Half
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.block.data.Bisected.Half <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/Bisected/Half.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Half(self, key)
   :canonical: pycraft.server.final.Half
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Half`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Half`]
      :async:
      :classmethod:
