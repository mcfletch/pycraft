...
Inheritance
------------
* pycraft.server.final.Hangable
* :py:class:`pycraft.server.final.BlockData`
* :py:class:`pycraft.server.world.BlockData`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.block.data.Hangable <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/Hangable.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Hangable(self, string_value=None, **named)
   :canonical: pycraft.server.final.Hangable
