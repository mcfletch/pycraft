...
Python Proxy to `org.bukkit.entity.Hanging <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Hanging.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Hanging(self, string_value=None, **named)
   :canonical: pycraft.server.final.Hanging
