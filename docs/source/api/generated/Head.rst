...
Inheritance
------------
* pycraft.server.final.Head
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.Wither.Head <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Wither/Head.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Head(self, key)
   :canonical: pycraft.server.final.Head
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Head`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Head`]
      :async:
      :classmethod:
