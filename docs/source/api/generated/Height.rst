...
Inheritance
------------
* pycraft.server.final.Height
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.block.data.type.Wall.Height <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Wall/Height.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Height(self, key)
   :canonical: pycraft.server.final.Height
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Height`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Height`]
      :async:
      :classmethod:
