...
Inheritance
------------
* pycraft.server.final.HeightMap
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.HeightMap <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/HeightMap.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: HeightMap(self, key)
   :canonical: pycraft.server.final.HeightMap
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`HeightMap`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`HeightMap`]
      :async:
      :classmethod:
