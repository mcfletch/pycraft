...
Inheritance
------------
* pycraft.server.final.Hinge
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.block.data.type.Door.Hinge <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Door/Hinge.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Hinge(self, key)
   :canonical: pycraft.server.final.Hinge
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Hinge`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Hinge`]
      :async:
      :classmethod:
