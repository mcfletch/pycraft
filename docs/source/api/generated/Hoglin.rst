...
Python Proxy to `org.bukkit.entity.Hoglin <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Hoglin.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Hoglin(self, **named)
   :canonical: pycraft.server.final.Hoglin
   ...
   .. py:method:: isAbleToBeHunted(self) -> bool
      :async:
   ...
   .. py:method:: setIsAbleToBeHunted(self, _0:boolean) -> None
      :async:
