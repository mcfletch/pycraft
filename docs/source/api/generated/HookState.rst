...
Inheritance
------------
* pycraft.server.final.HookState
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.FishHook.HookState <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/FishHook/HookState.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: HookState(self, key)
   :canonical: pycraft.server.final.HookState
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`HookState`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`HookState`]
      :async:
      :classmethod:
