...
Inheritance
------------
* pycraft.server.final.Hopper
* :py:class:`pycraft.server.world.Hopper`
...
Python Proxy to `org.bukkit.block.data.type.Hopper <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Hopper.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Hopper(self, string_value=None, **named)
   :canonical: pycraft.server.final.Hopper
