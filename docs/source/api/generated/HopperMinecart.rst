...
Inheritance
------------
* pycraft.server.final.HopperMinecart
* :py:class:`pycraft.server.final.Minecart`
...
Python Proxy to `org.bukkit.entity.minecart.HopperMinecart <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/minecart/HopperMinecart.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: HopperMinecart(self, **named)
   :canonical: pycraft.server.final.HopperMinecart
   ...
   .. py:method:: getDerailedVelocityMod(self) -> :py:class:`Vector`
      :async:


   .. py:method:: getDisplayBlock(self) -> :py:class:`MaterialData`
      :async:


   .. py:method:: getDisplayBlockData(self) -> :py:class:`BlockData`
      :async:


   .. py:method:: getDisplayBlockOffset(self) -> int
      :async:
   ...
   .. py:method:: getFlyingVelocityMod(self) -> :py:class:`Vector`
      :async:
   ...
   .. py:method:: getLastFilled(self) -> :py:class:`long`
      :async:
   ...
   .. py:method:: getMaxSpeed(self) -> float
      :async:
   ...
   .. py:method:: getMinecartMaterial(self) -> :py:class:`Material`
      :async:
   ...
   .. py:method:: getNextRefill(self) -> :py:class:`long`
      :async:
   ...
   .. py:method:: getPickupCooldown(self) -> int
      :async:
   ...
   .. py:method:: hasBeenFilled(self) -> bool
      :async:
   ...
   .. py:method:: hasPendingRefill(self) -> bool
      :async:
   ...
   .. py:method:: hasPlayerLooted

       .. py:method:: hasPlayerLooted(self, _0:Player) -> bool
          :async:
          :noindex:

       .. py:method:: hasPlayerLooted(self, _0:UUID) -> bool
          :async:
          :noindex:
   ...
   .. py:method:: isRefillEnabled(self) -> bool
      :async:
   ...
   .. py:method:: isSlowWhenEmpty(self) -> bool
      :async:
   ...
   .. py:method:: setDerailedVelocityMod(self, _0:Vector) -> None
      :async:


   .. py:method:: setDisplayBlock(self, _0:MaterialData) -> None
      :async:


   .. py:method:: setDisplayBlockData(self, _0:BlockData) -> None
      :async:


   .. py:method:: setDisplayBlockOffset(self, _0:int) -> None
      :async:


   .. py:method:: setEnabled(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setFlyingVelocityMod(self, _0:Vector) -> None
      :async:
   ...
   .. py:method:: setMaxSpeed(self, _0:double) -> None
      :async:
   ...
   .. py:method:: setNextRefill(self, _0:long) -> :py:class:`long`
      :async:
   ...
   .. py:method:: setPickupCooldown(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setSlowWhenEmpty(self, _0:boolean) -> None
      :async:
