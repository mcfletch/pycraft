...
Python Proxy to `org.bukkit.entity.Horse <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Horse.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Horse(self, **named)
   :canonical: pycraft.server.final.Horse
   ...
   .. py:method:: getInventory
       ...
       .. py:method:: getInventory(self) -> :py:class:`HorseInventory`
          :async:
          :noindex:
   ...
   .. py:method:: getStyle(self) -> :py:class:`Style`
      :async:
   ...
   .. py:method:: setStyle(self, _0:Style) -> None
      :async:
