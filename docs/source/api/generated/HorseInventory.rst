...
Inheritance
------------
* pycraft.server.final.HorseInventory
* :py:class:`pycraft.server.final.ArmoredHorseInventory`
* :py:class:`pycraft.server.final.AbstractHorseInventory`
* :py:class:`pycraft.server.final.Inventory`
* :py:class:`pycraft.server.world.Inventory`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.inventory.HorseInventory <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/HorseInventory.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: HorseInventory(self, *args, **named)
   :canonical: pycraft.server.final.HorseInventory
   ...
   .. py:method:: getArmor(self) -> :py:class:`ItemStack`
      :async:
   ...
   .. py:method:: setArmor(self, _0:ItemStack) -> None
      :async:
