...
Inheritance
------------
* pycraft.server.final.HumanEntity
...
Python Proxy to `org.bukkit.entity.HumanEntity <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/HumanEntity.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: HumanEntity(self, **named)
   :canonical: pycraft.server.final.HumanEntity
