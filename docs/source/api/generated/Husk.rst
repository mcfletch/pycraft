...
Python Proxy to `org.bukkit.entity.Husk <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Husk.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Husk(self, **named)
   :canonical: pycraft.server.final.Husk
