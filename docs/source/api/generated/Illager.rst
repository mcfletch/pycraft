...
Python Proxy to `org.bukkit.entity.Illager <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Illager.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Illager(self, **named)
   :canonical: pycraft.server.final.Illager
