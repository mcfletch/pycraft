...
Inheritance
------------
* pycraft.server.final.Illusioner
...
Python Proxy to `org.bukkit.entity.Illusioner <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Illusioner.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Illusioner(self, **named)
   :canonical: pycraft.server.final.Illusioner
