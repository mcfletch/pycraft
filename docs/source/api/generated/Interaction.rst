...
Inheritance
------------
* pycraft.server.final.Interaction
...
Python Proxy to `org.bukkit.entity.Interaction <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Interaction.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Interaction(self, **named)
   :canonical: pycraft.server.final.Interaction
   ...
   .. py:method:: getInteractionHeight(self) -> float
      :async:


   .. py:method:: getInteractionWidth(self) -> float
      :async:


   .. py:method:: getLastAttack(self) -> :py:class:`PreviousInteraction`
      :async:
   ...
   .. py:method:: getLastInteraction(self) -> :py:class:`PreviousInteraction`
      :async:
   ...
   .. py:method:: isResponsive(self) -> bool
      :async:
   ...
   .. py:method:: setInteractionHeight(self, _0:float) -> None
      :async:


   .. py:method:: setInteractionWidth(self, _0:float) -> None
      :async:
   ...
   .. py:method:: setResponsive(self, _0:boolean) -> None
      :async:
