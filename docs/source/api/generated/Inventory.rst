...
Inheritance
------------
* pycraft.server.final.Inventory
* :py:class:`pycraft.server.world.Inventory`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.inventory.Inventory <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/Inventory.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Inventory(self, *args, **named)
   :canonical: pycraft.server.final.Inventory
