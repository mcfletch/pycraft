...
Inheritance
------------
* pycraft.server.final.InventoryType
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.event.inventory.InventoryType <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/event/inventory/InventoryType.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: InventoryType(self, key)
   :canonical: pycraft.server.final.InventoryType
   ...
   .. py:method:: defaultTitle(self) -> :py:class:`Component`
      :async:
   ...
   .. py:method:: getDefaultSize(self) -> int
      :async:


   .. py:method:: getDefaultTitle(self) -> str
      :async:
   ...
   .. py:method:: isCreatable(self) -> bool
      :async:
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`InventoryType`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`InventoryType`]
      :async:
      :classmethod:
