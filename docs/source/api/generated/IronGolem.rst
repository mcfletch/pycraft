...
Inheritance
------------
* pycraft.server.final.IronGolem
...
Python Proxy to `org.bukkit.entity.IronGolem <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/IronGolem.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: IronGolem(self, **named)
   :canonical: pycraft.server.final.IronGolem
   ...
   .. py:method:: isPlayerCreated(self) -> bool
      :async:
   ...
   .. py:method:: setPlayerCreated(self, _0:boolean) -> None
      :async:
