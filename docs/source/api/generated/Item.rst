...
Python Proxy to `org.bukkit.entity.Item <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Item.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Item(self, **named)
   :canonical: pycraft.server.final.Item
   ...
   .. py:method:: canMobPickup(self) -> bool
      :async:


   .. py:method:: canPlayerPickup(self) -> bool
      :async:
   ...
   .. py:method:: getOwner(self) -> uuid.UUID
      :async:
   ...
   .. py:method:: getPickupDelay(self) -> int
      :async:
   ...
   .. py:method:: getThrower(self) -> uuid.UUID
      :async:
   ...
   .. py:method:: isUnlimitedLifetime(self) -> bool
      :async:
   ...
   .. py:method:: setCanMobPickup(self, _0:boolean) -> None
      :async:


   .. py:method:: setCanPlayerPickup(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setHealth(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setOwner(self, _0:UUID) -> None
      :async:
   ...
   .. py:method:: setPickupDelay(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setThrower(self, _0:UUID) -> None
      :async:
   ...
   .. py:method:: setUnlimitedLifetime(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setWillAge(self, _0:boolean) -> None
      :async:
