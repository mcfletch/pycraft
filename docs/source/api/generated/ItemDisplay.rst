...
Inheritance
------------
* pycraft.server.final.ItemDisplay
...
Python Proxy to `org.bukkit.entity.ItemDisplay <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/ItemDisplay.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: ItemDisplay(self, **named)
   :canonical: pycraft.server.final.ItemDisplay
   ...
   .. py:method:: getItemDisplayTransform(self) -> :py:class:`ItemDisplayTransform`
      :async:
   ...
   .. py:method:: setItemDisplayTransform(self, _0:ItemDisplayTransform) -> None
      :async:


   .. py:method:: setItemStack(self, _0:ItemStack) -> None
      :async:
