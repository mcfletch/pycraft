...
Inheritance
------------
* pycraft.server.final.ItemDisplayTransform
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.ItemDisplay.ItemDisplayTransform <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/ItemDisplay/ItemDisplayTransform.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: ItemDisplayTransform(self, key)
   :canonical: pycraft.server.final.ItemDisplayTransform
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`ItemDisplayTransform`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`ItemDisplayTransform`]
      :async:
      :classmethod:
