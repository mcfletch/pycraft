...
Inheritance
------------
* pycraft.server.final.ItemFlag
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.inventory.ItemFlag <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/ItemFlag.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: ItemFlag(self, key)
   :canonical: pycraft.server.final.ItemFlag
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`ItemFlag`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`ItemFlag`]
      :async:
      :classmethod:
