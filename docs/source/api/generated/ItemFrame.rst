...
Inheritance
------------
* pycraft.server.final.ItemFrame
...
Python Proxy to `org.bukkit.entity.ItemFrame <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/ItemFrame.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: ItemFrame(self, string_value=None, **named)
   :canonical: pycraft.server.final.ItemFrame
