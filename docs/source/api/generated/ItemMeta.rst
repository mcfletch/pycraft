...
Python Proxy to `org.bukkit.inventory.meta.ItemMeta <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/meta/ItemMeta.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: ItemMeta(self, **named)
   :canonical: pycraft.server.final.ItemMeta
