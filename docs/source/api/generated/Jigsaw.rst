...
Inheritance
------------
* pycraft.server.final.Jigsaw
* :py:class:`pycraft.server.world.Jigsaw`
* :py:class:`pycraft.server.final.BlockData`
* :py:class:`pycraft.server.world.BlockData`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.block.data.type.Jigsaw <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Jigsaw.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Jigsaw(self, string_value=None, **named)
   :canonical: pycraft.server.final.Jigsaw
   ...
   .. py:method:: getOrientation(self) -> :py:class:`Orientation`
      :async:
   ...
   .. py:method:: setOrientation(self, _0:Orientation) -> None
      :async:
