...
Inheritance
------------
* pycraft.server.final.KnowledgeBookMeta
...
Python Proxy to `org.bukkit.inventory.meta.KnowledgeBookMeta <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/meta/KnowledgeBookMeta.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: KnowledgeBookMeta(self, **named)
   :canonical: pycraft.server.final.KnowledgeBookMeta
   ...
   .. py:method:: addRecipe(self, _0:NamespacedKey[]) -> None
      :async:
   ...
   .. py:method:: getRecipes(self) -> typing.List[:py:class:`NamespacedKey`]
      :async:
   ...
   .. py:method:: hasRecipes(self) -> bool
      :async:
