...
Inheritance
------------
* pycraft.server.final.Ladder
* :py:class:`pycraft.server.world.Ladder`
...
Python Proxy to `org.bukkit.block.data.type.Ladder <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Ladder.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Ladder(self, string_value=None, **named)
   :canonical: pycraft.server.final.Ladder
