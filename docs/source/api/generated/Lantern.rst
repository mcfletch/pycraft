...
Inheritance
------------
* pycraft.server.final.Lantern
* :py:class:`pycraft.server.world.Lantern`
* :py:class:`pycraft.server.final.Hangable`
...
Python Proxy to `org.bukkit.block.data.type.Lantern <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Lantern.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Lantern(self, string_value=None, **named)
   :canonical: pycraft.server.final.Lantern
   ...
   .. py:method:: setHanging(self, _0:boolean) -> None
      :async:
