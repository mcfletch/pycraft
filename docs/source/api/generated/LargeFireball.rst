...
Inheritance
------------
* pycraft.server.final.LargeFireball
...
Python Proxy to `org.bukkit.entity.LargeFireball <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/LargeFireball.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: LargeFireball(self, **named)
   :canonical: pycraft.server.final.LargeFireball
