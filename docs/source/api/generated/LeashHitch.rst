...
Inheritance
------------
* pycraft.server.final.LeashHitch
...
Python Proxy to `org.bukkit.entity.LeashHitch <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/LeashHitch.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: LeashHitch(self, string_value=None, **named)
   :canonical: pycraft.server.final.LeashHitch
