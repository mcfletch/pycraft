...
Inheritance
------------
* pycraft.server.final.LeatherArmorMeta
...
Python Proxy to `org.bukkit.inventory.meta.LeatherArmorMeta <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/meta/LeatherArmorMeta.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: LeatherArmorMeta(self, **named)
   :canonical: pycraft.server.final.LeatherArmorMeta
