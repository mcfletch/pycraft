...
Inheritance
------------
* pycraft.server.final.LightningStrike
...
Python Proxy to `org.bukkit.entity.LightningStrike <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/LightningStrike.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: LightningStrike(self, **named)
   :canonical: pycraft.server.final.LightningStrike
   ...
   .. py:method:: getCausingEntity(self) -> :py:class:`Entity`
      :async:
   ...
   .. py:method:: getFlashCount(self) -> int
      :async:
   ...
   .. py:method:: setCausingPlayer(self, _0:Player) -> None
      :async:
   ...
   .. py:method:: setFlashCount(self, _0:int) -> None
      :async:
