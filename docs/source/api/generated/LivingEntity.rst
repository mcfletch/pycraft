...
Inheritance
------------
* pycraft.server.final.LivingEntity
...
Python Proxy to `org.bukkit.entity.LivingEntity <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/LivingEntity.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: LivingEntity(self, **named)
   :canonical: pycraft.server.final.LivingEntity
