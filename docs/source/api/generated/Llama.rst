...
Python Proxy to `org.bukkit.entity.Llama <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Llama.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Llama(self, **named)
   :canonical: pycraft.server.final.Llama
