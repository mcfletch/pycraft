...
Inheritance
------------
* pycraft.server.final.LlamaInventory
* :py:class:`pycraft.server.final.SaddledHorseInventory`
...
Python Proxy to `org.bukkit.inventory.LlamaInventory <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/LlamaInventory.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: LlamaInventory(self, *args, **named)
   :canonical: pycraft.server.final.LlamaInventory
   ...
   .. py:method:: getDecor(self) -> :py:class:`ItemStack`
      :async:
   ...
   .. py:method:: setDecor(self, _0:ItemStack) -> None
      :async:
