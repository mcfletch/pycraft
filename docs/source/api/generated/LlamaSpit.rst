...
Inheritance
------------
* pycraft.server.final.LlamaSpit
...
Python Proxy to `org.bukkit.entity.LlamaSpit <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/LlamaSpit.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: LlamaSpit(self, **named)
   :canonical: pycraft.server.final.LlamaSpit
