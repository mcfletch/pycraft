...
Inheritance
------------
* pycraft.server.final.LoadLevel
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.Chunk.LoadLevel <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/Chunk/LoadLevel.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: LoadLevel(self, key)
   :canonical: pycraft.server.final.LoadLevel
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`LoadLevel`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`LoadLevel`]
      :async:
      :classmethod:
