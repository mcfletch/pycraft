...
Inheritance
------------
* pycraft.server.final.LockType
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.ArmorStand.LockType <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/ArmorStand/LockType.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: LockType(self, key)
   :canonical: pycraft.server.final.LockType
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`LockType`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`LockType`]
      :async:
      :classmethod:
