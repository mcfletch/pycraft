...
Inheritance
------------
* pycraft.server.final.MagmaCube
* :py:class:`pycraft.server.final.Slime`
...
Python Proxy to `org.bukkit.entity.MagmaCube <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/MagmaCube.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: MagmaCube(self, **named)
   :canonical: pycraft.server.final.MagmaCube
   ...
   .. py:method:: setWander(self, _0:boolean) -> None
      :async:
