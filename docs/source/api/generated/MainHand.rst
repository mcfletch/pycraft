...
Inheritance
------------
* pycraft.server.final.MainHand
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.inventory.MainHand <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/MainHand.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: MainHand(self, key)
   :canonical: pycraft.server.final.MainHand
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`MainHand`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`MainHand`]
      :async:
      :classmethod:
