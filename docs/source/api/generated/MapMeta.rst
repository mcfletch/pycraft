...
Python Proxy to `org.bukkit.inventory.meta.MapMeta <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/meta/MapMeta.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: MapMeta(self, **named)
   :canonical: pycraft.server.final.MapMeta
   ...
   .. py:method:: getLocationName(self) -> str
      :async:
   ...
   .. py:method:: hasLocationName(self) -> bool
      :async:
   ...
   .. py:method:: hasMapId(self) -> bool
      :async:


   .. py:method:: hasMapView(self) -> bool
      :async:
   ...
   .. py:method:: setLocationName(self, _0:String) -> None
      :async:
   ...
   .. py:method:: setMapId(self, _0:int) -> None
      :async:


   .. py:method:: setMapView(self, _0:MapView) -> None
      :async:
   ...
   .. py:method:: setScaling(self, _0:boolean) -> None
      :async:
