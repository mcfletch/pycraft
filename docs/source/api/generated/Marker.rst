...
Python Proxy to `org.bukkit.entity.Marker <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Marker.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Marker(self, **named)
   :canonical: pycraft.server.final.Marker
