...
Inheritance
------------
* pycraft.server.final.MemoryConfiguration
...
Python Proxy to `org.bukkit.configuration.MemoryConfiguration <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/configuration/MemoryConfiguration.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: MemoryConfiguration(self, **named)
   :canonical: pycraft.server.final.MemoryConfiguration
