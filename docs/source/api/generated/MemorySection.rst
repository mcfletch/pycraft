...
Inheritance
------------
* pycraft.server.final.MemorySection
* :py:class:`pycraft.server.final.ConfigurationSection`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.configuration.MemorySection <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/configuration/MemorySection.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: MemorySection(self, **named)
   :canonical: pycraft.server.final.MemorySection
