...
Python Proxy to `org.bukkit.entity.Minecart <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Minecart.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Minecart(self, **named)
   :canonical: pycraft.server.final.Minecart
