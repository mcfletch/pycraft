...
Inheritance
------------
* pycraft.server.final.Mirror
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.block.structure.Mirror <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/structure/Mirror.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Mirror(self, key)
   :canonical: pycraft.server.final.Mirror
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Mirror`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Mirror`]
      :async:
      :classmethod:
