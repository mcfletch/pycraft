...
Python Proxy to `org.bukkit.entity.Mob <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Mob.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Mob(self, **named)
   :canonical: pycraft.server.final.Mob
