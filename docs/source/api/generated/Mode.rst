...
Inheritance
------------
* pycraft.server.final.Mode
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.block.data.type.Comparator.Mode <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Comparator/Mode.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Mode(self, key)
   :canonical: pycraft.server.final.Mode
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Mode`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Mode`]
      :async:
      :classmethod:
