...
Python Proxy to `org.bukkit.entity.Monster <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Monster.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Monster(self, **named)
   :canonical: pycraft.server.final.Monster
