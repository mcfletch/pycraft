...
Python Proxy to `org.bukkit.entity.Mule <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Mule.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Mule(self, **named)
   :canonical: pycraft.server.final.Mule
