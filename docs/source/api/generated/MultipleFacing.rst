...
Inheritance
------------
* pycraft.server.final.MultipleFacing
* :py:class:`pycraft.server.final.BlockData`
* :py:class:`pycraft.server.world.BlockData`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.block.data.MultipleFacing <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/MultipleFacing.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: MultipleFacing(self, string_value=None, **named)
   :canonical: pycraft.server.final.MultipleFacing
