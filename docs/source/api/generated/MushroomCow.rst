...
Inheritance
------------
* pycraft.server.final.MushroomCow
* :py:class:`pycraft.server.final.Cow`
...
Python Proxy to `org.bukkit.entity.MushroomCow <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/MushroomCow.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: MushroomCow(self, **named)
   :canonical: pycraft.server.final.MushroomCow
   ...
   .. py:method:: getStewEffectDuration(self) -> int
      :async:


   .. py:method:: getStewEffectType(self) -> :py:class:`PotionEffectType`
      :async:
   ...
   .. py:method:: readyToBeSheared(self) -> bool
      :async:
   ...
   .. py:method:: setStewEffect(self, _0:PotionEffectType) -> None
      :async:


   .. py:method:: setStewEffectDuration(self, _0:int) -> None
      :async:
   ...
   .. py:method:: shear
       ...
       .. py:method:: shear(self) -> None
          :async:
          :noindex:

       .. py:method:: shear(self, _0:Source) -> None
          :async:
          :noindex:
