...
Python Proxy to `org.bukkit.entity.NPC <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/NPC.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: NPC(self, **named)
   :canonical: pycraft.server.final.NPC
