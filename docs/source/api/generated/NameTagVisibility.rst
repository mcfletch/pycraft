...
Inheritance
------------
* pycraft.server.final.NameTagVisibility
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.scoreboard.NameTagVisibility <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/scoreboard/NameTagVisibility.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: NameTagVisibility(self, key)
   :canonical: pycraft.server.final.NameTagVisibility
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`NameTagVisibility`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`NameTagVisibility`]
      :async:
      :classmethod:
