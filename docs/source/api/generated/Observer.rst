...
Inheritance
------------
* pycraft.server.final.Observer
* :py:class:`pycraft.server.world.Observer`
...
Python Proxy to `org.bukkit.block.data.type.Observer <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Observer.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Observer(self, string_value=None, **named)
   :canonical: pycraft.server.final.Observer
