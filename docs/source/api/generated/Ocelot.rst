...
Python Proxy to `org.bukkit.entity.Ocelot <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Ocelot.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Ocelot(self, **named)
   :canonical: pycraft.server.final.Ocelot
   ...
   .. py:method:: isTrusting(self) -> bool
      :async:
   ...
   .. py:method:: setTrusting(self, _0:boolean) -> None
      :async:
