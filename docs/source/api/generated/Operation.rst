...
Inheritance
------------
* pycraft.server.final.Operation
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.attribute.AttributeModifier.Operation <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/attribute/AttributeModifier/Operation.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Operation(self, key)
   :canonical: pycraft.server.final.Operation
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Operation`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Operation`]
      :async:
      :classmethod:
