...
Inheritance
------------
* pycraft.server.final.Option
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.scoreboard.Team.Option <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/scoreboard/Team/Option.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Option(self, key)
   :canonical: pycraft.server.final.Option
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Option`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Option`]
      :async:
      :classmethod:
