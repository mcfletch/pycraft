...
Inheritance
------------
* pycraft.server.final.OptionStatus
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.scoreboard.Team.OptionStatus <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/scoreboard/Team/OptionStatus.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: OptionStatus(self, key)
   :canonical: pycraft.server.final.OptionStatus
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`OptionStatus`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`OptionStatus`]
      :async:
      :classmethod:
