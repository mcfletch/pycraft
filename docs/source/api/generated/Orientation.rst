...
Inheritance
------------
* pycraft.server.final.Orientation
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.block.data.type.Jigsaw.Orientation <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Jigsaw/Orientation.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Orientation(self, key)
   :canonical: pycraft.server.final.Orientation
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Orientation`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Orientation`]
      :async:
      :classmethod:
