...
Python Proxy to `org.bukkit.entity.Painting <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Painting.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Painting(self, string_value=None, **named)
   :canonical: pycraft.server.final.Painting
   ...
   .. py:method:: getArt(self) -> :py:class:`Art`
      :async:
   ...
   .. py:method:: setArt
       ...
       .. py:method:: setArt(self, _0:Art) -> bool
          :async:
          :noindex:

       .. py:method:: setArt(self, _0:Art, _1:boolean) -> bool
          :async:
          :noindex:
