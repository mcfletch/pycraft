...
Python Proxy to `org.bukkit.entity.Panda <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Panda.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Panda(self, **named)
   :canonical: pycraft.server.final.Panda
   ...
   .. py:method:: getEatingTicks(self) -> int
      :async:
   ...
   .. py:method:: getHiddenGene(self) -> :py:class:`Gene`
      :async:
   ...
   .. py:method:: getMainGene(self) -> :py:class:`Gene`
      :async:
   ...
   .. py:method:: getSneezeTicks(self) -> int
      :async:
   ...
   .. py:method:: getUnhappyTicks(self) -> int
      :async:
   ...
   .. py:method:: isRolling(self) -> bool
      :async:


   .. py:method:: isScared(self) -> bool
      :async:
   ...
   .. py:method:: isSneezing(self) -> bool
      :async:
   ...
   .. py:method:: setEatingTicks(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setHiddenGene(self, _0:Gene) -> None
      :async:
   ...
   .. py:method:: setIsOnBack(self, _0:boolean) -> None
      :async:


   .. py:method:: setIsSitting(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setMainGene(self, _0:Gene) -> None
      :async:
   ...
   .. py:method:: setOnBack(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setRolling(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setSneezeTicks(self, _0:int) -> None
      :async:


   .. py:method:: setSneezing(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setUnhappyTicks(self, _0:int) -> None
      :async:
