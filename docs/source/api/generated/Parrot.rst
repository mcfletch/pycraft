...
Python Proxy to `org.bukkit.entity.Parrot <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Parrot.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Parrot(self, **named)
   :canonical: pycraft.server.final.Parrot
