...
Inheritance
------------
* pycraft.server.final.Part
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.block.data.type.Bed.Part <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Bed/Part.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Part(self, key)
   :canonical: pycraft.server.final.Part
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Part`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Part`]
      :async:
      :classmethod:
