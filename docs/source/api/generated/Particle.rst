...
Inheritance
------------
* pycraft.server.final.Particle
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.Particle <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/Particle.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Particle(self, key)
   :canonical: pycraft.server.final.Particle
   ...
   .. py:method:: builder(self) -> :py:class:`ParticleBuilder`
      :async:
   ...
   .. py:method:: getDataType(self) -> :py:class:`Class`
      :async:
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Particle`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Particle`]
      :async:
      :classmethod:
