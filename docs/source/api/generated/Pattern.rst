...
Inheritance
------------
* pycraft.server.final.Pattern
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.TropicalFish.Pattern <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/TropicalFish/Pattern.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Pattern(self, key)
   :canonical: pycraft.server.final.Pattern
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Pattern`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Pattern`]
      :async:
      :classmethod:
