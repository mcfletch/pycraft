...
Inheritance
------------
* pycraft.server.final.PermissionDefault
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.permissions.PermissionDefault <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/permissions/PermissionDefault.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: PermissionDefault(self, key)
   :canonical: pycraft.server.final.PermissionDefault
   ...
   .. py:method:: getByName(cls, _0:String) -> :py:class:`PermissionDefault`
      :async:
      :classmethod:
   ...
   .. py:method:: getValue(self, _0:boolean) -> bool
      :async:
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`PermissionDefault`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`PermissionDefault`]
      :async:
      :classmethod:
