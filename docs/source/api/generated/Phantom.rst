...
Inheritance
------------
* pycraft.server.final.Phantom
* :py:class:`pycraft.server.final.Flying`
...
Python Proxy to `org.bukkit.entity.Phantom <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Phantom.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Phantom(self, **named)
   :canonical: pycraft.server.final.Phantom
   ...
   .. py:method:: getAnchorLocation(self) -> :py:class:`Location`
      :async:
   ...
   .. py:method:: setAnchorLocation(self, _0:Location) -> None
      :async:
   ...
   .. py:method:: setSize(self, _0:int) -> None
      :async:
