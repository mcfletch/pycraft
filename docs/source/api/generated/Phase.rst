...
Inheritance
------------
* pycraft.server.final.Phase
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.EnderDragon.Phase <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/EnderDragon/Phase.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Phase(self, key)
   :canonical: pycraft.server.final.Phase
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Phase`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Phase`]
      :async:
      :classmethod:
