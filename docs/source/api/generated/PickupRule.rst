...
Inheritance
------------
* pycraft.server.final.PickupRule
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.AbstractArrow.PickupRule <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/AbstractArrow/PickupRule.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: PickupRule(self, key)
   :canonical: pycraft.server.final.PickupRule
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`PickupRule`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`PickupRule`]
      :async:
      :classmethod:
