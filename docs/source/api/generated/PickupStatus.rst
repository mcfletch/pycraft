...
Inheritance
------------
* pycraft.server.final.PickupStatus
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.AbstractArrow.PickupStatus <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/AbstractArrow/PickupStatus.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: PickupStatus(self, key)
   :canonical: pycraft.server.final.PickupStatus
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`PickupStatus`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`PickupStatus`]
      :async:
      :classmethod:
