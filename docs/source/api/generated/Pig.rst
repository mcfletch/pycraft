...
Python Proxy to `org.bukkit.entity.Pig <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Pig.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Pig(self, **named)
   :canonical: pycraft.server.final.Pig
