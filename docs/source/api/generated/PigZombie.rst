...
Inheritance
------------
* pycraft.server.final.PigZombie
...
Python Proxy to `org.bukkit.entity.PigZombie <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/PigZombie.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: PigZombie(self, **named)
   :canonical: pycraft.server.final.PigZombie
   ...
   .. py:method:: setAngry(self, _0:boolean) -> None
      :async:
