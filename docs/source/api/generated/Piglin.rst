...
Inheritance
------------
* pycraft.server.final.Piglin
* :py:class:`pycraft.server.final.PiglinAbstract`
...
Python Proxy to `org.bukkit.entity.Piglin <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Piglin.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Piglin(self, **named)
   :canonical: pycraft.server.final.Piglin
   ...
   .. py:method:: addBarterMaterial(self, _0:Material) -> bool
      :async:


   .. py:method:: addMaterialOfInterest(self, _0:Material) -> bool
      :async:
   ...
   .. py:method:: getBarterList(self) -> typing.List[:py:class:`Material`]
      :async:
   ...
   .. py:method:: getInterestList(self) -> typing.List[:py:class:`Material`]
      :async:
   ...
   .. py:method:: isAbleToHunt(self) -> bool
      :async:
   ...
   .. py:method:: isChargingCrossbow(self) -> bool
      :async:
   ...
   .. py:method:: isImmuneToZombification(self) -> bool
      :async:
   ...
   .. py:method:: removeBarterMaterial(self, _0:Material) -> bool
      :async:


   .. py:method:: removeMaterialOfInterest(self, _0:Material) -> bool
      :async:
   ...
   .. py:method:: setChargingCrossbow(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setImmuneToZombification(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setIsAbleToHunt(self, _0:boolean) -> None
      :async:
