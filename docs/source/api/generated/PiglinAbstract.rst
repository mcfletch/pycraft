...
Inheritance
------------
* pycraft.server.final.PiglinAbstract
...
Python Proxy to `org.bukkit.entity.PiglinAbstract <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/PiglinAbstract.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: PiglinAbstract(self, **named)
   :canonical: pycraft.server.final.PiglinAbstract
