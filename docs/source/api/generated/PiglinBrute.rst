...
Inheritance
------------
* pycraft.server.final.PiglinBrute
...
Python Proxy to `org.bukkit.entity.PiglinBrute <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/PiglinBrute.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: PiglinBrute(self, **named)
   :canonical: pycraft.server.final.PiglinBrute
