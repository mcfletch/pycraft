...
Python Proxy to `org.bukkit.entity.Pillager <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Pillager.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Pillager(self, **named)
   :canonical: pycraft.server.final.Pillager
