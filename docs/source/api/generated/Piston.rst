...
Inheritance
------------
* pycraft.server.final.Piston
* :py:class:`pycraft.server.world.Piston`
...
Python Proxy to `org.bukkit.block.data.type.Piston <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Piston.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Piston(self, string_value=None, **named)
   :canonical: pycraft.server.final.Piston
   ...
   .. py:method:: setExtended(self, _0:boolean) -> None
      :async:
