...
Inheritance
------------
* pycraft.server.final.PistonHead
* :py:class:`pycraft.server.world.PistonHead`
* :py:class:`pycraft.server.final.TechnicalPiston`
* :py:class:`pycraft.server.world.TechnicalPiston`
...
Python Proxy to `org.bukkit.block.data.type.PistonHead <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/PistonHead.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: PistonHead(self, string_value=None, **named)
   :canonical: pycraft.server.final.PistonHead
   ...
   .. py:method:: setShort(self, _0:boolean) -> None
      :async:
