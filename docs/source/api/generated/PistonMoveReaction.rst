...
Inheritance
------------
* pycraft.server.final.PistonMoveReaction
* :py:class:`pycraft.server.world.PistonMoveReaction`
...
Python Proxy to `org.bukkit.block.PistonMoveReaction <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/PistonMoveReaction.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: PistonMoveReaction(self, key)
   :canonical: pycraft.server.final.PistonMoveReaction
   ...
   .. py:method:: getById(cls, _0:int) -> :py:class:`PistonMoveReaction`
      :async:
      :classmethod:
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`PistonMoveReaction`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`PistonMoveReaction`]
      :async:
      :classmethod:
