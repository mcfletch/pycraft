...
Inheritance
------------
* pycraft.server.final.PluginLoadOrder
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.plugin.PluginLoadOrder <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/plugin/PluginLoadOrder.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: PluginLoadOrder(self, key)
   :canonical: pycraft.server.final.PluginLoadOrder
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`PluginLoadOrder`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`PluginLoadOrder`]
      :async:
      :classmethod:
