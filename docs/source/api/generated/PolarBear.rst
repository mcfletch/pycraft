...
Inheritance
------------
* pycraft.server.final.PolarBear
...
Python Proxy to `org.bukkit.entity.PolarBear <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/PolarBear.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: PolarBear(self, **named)
   :canonical: pycraft.server.final.PolarBear
   ...
   .. py:method:: isStanding(self) -> bool
      :async:
   ...
   .. py:method:: setStanding(self, _0:boolean) -> None
      :async:
