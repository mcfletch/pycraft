...
Inheritance
------------
* pycraft.server.final.Pose
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.Pose <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Pose.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Pose(self, key)
   :canonical: pycraft.server.final.Pose
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Pose`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Pose`]
      :async:
      :classmethod:
