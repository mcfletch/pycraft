...
Inheritance
------------
* pycraft.server.final.PotionMeta
...
Python Proxy to `org.bukkit.inventory.meta.PotionMeta <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/meta/PotionMeta.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: PotionMeta(self, **named)
   :canonical: pycraft.server.final.PotionMeta
   ...
   .. py:method:: clearCustomEffects(self) -> bool
      :async:
   ...
   .. py:method:: setMainEffect(self, _0:PotionEffectType) -> bool
      :async:
