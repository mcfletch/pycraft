...
Inheritance
------------
* pycraft.server.final.PotionType
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.potion.PotionType <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/potion/PotionType.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: PotionType(self, key)
   :canonical: pycraft.server.final.PotionType
   ...
   .. py:method:: getByEffect(cls, _0:PotionEffectType) -> :py:class:`PotionType`
      :async:
      :classmethod:
   ...
   .. py:method:: getEffectType(self) -> :py:class:`PotionEffectType`
      :async:
   ...
   .. py:method:: isExtendable(self) -> bool
      :async:
   ...
   .. py:method:: isUpgradeable(self) -> bool
      :async:
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`PotionType`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`PotionType`]
      :async:
      :classmethod:
