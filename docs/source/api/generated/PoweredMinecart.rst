...
Inheritance
------------
* pycraft.server.final.PoweredMinecart
...
Python Proxy to `org.bukkit.entity.minecart.PoweredMinecart <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/minecart/PoweredMinecart.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: PoweredMinecart(self, **named)
   :canonical: pycraft.server.final.PoweredMinecart
   ...
   .. py:method:: getPushX(self) -> float
      :async:


   .. py:method:: getPushZ(self) -> float
      :async:
   ...
   .. py:method:: setFuel(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setPushX(self, _0:double) -> None
      :async:


   .. py:method:: setPushZ(self, _0:double) -> None
      :async:
