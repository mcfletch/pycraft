...
Inheritance
------------
* pycraft.server.final.Profession
...
Python Proxy to `org.bukkit.entity.Villager.Profession <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Villager/Profession.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Profession(self, key)
   :canonical: pycraft.server.final.Profession
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Profession`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Profession`]
      :async:
      :classmethod:
