...
Inheritance
------------
* pycraft.server.final.Projectile
...
Python Proxy to `org.bukkit.entity.Projectile <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Projectile.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Projectile(self, **named)
   :canonical: pycraft.server.final.Projectile
