...
Inheritance
------------
* pycraft.server.final.Property
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.inventory.InventoryView.Property <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/InventoryView/Property.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Property(self, key)
   :canonical: pycraft.server.final.Property
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Property`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Property`]
      :async:
      :classmethod:
