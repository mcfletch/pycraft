...
Inheritance
------------
* pycraft.server.final.PufferFish
...
Python Proxy to `org.bukkit.entity.PufferFish <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/PufferFish.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: PufferFish(self, **named)
   :canonical: pycraft.server.final.PufferFish
   ...
   .. py:method:: getPuffState(self) -> int
      :async:
   ...
   .. py:method:: setPuffState(self, _0:int) -> None
      :async:
