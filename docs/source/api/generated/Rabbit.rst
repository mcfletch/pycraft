...
Python Proxy to `org.bukkit.entity.Rabbit <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Rabbit.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Rabbit(self, **named)
   :canonical: pycraft.server.final.Rabbit
   ...
   .. py:method:: getMoreCarrotTicks(self) -> int
      :async:
   ...
   .. py:method:: getRabbitType(self) -> :py:class:`Type`
      :async:
   ...
   .. py:method:: setMoreCarrotTicks(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setRabbitType(self, _0:Type) -> None
      :async:
