...
Inheritance
------------
* pycraft.server.final.RaidStatus
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.Raid.RaidStatus <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/Raid/RaidStatus.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: RaidStatus(self, key)
   :canonical: pycraft.server.final.RaidStatus
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`RaidStatus`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`RaidStatus`]
      :async:
      :classmethod:
