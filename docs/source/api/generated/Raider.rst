...
Python Proxy to `org.bukkit.entity.Raider <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Raider.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Raider(self, **named)
   :canonical: pycraft.server.final.Raider
