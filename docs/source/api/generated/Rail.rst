...
Python Proxy to `org.bukkit.block.data.Rail <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/Rail.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Rail(self, string_value=None, **named)
   :canonical: pycraft.server.final.Rail
