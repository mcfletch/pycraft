...
Python Proxy to `org.bukkit.entity.Ravager <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Ravager.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Ravager(self, **named)
   :canonical: pycraft.server.final.Ravager
   ...
   .. py:method:: getAttackTicks(self) -> int
      :async:
   ...
   .. py:method:: getRoarTicks(self) -> int
      :async:
   ...
   .. py:method:: getStunnedTicks(self) -> int
      :async:
   ...
   .. py:method:: setAttackTicks(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setRoarTicks(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setStunnedTicks(self, _0:int) -> None
      :async:
