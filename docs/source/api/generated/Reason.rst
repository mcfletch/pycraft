...
Inheritance
------------
* pycraft.server.final.Reason
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.event.inventory.InventoryCloseEvent.Reason <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/event/inventory/InventoryCloseEvent/Reason.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Reason(self, key)
   :canonical: pycraft.server.final.Reason
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Reason`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Reason`]
      :async:
      :classmethod:
