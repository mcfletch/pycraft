...
Inheritance
------------
* pycraft.server.final.RedstoneRail
* :py:class:`pycraft.server.world.RedstoneRail`
* :py:class:`pycraft.server.final.Powerable`
* :py:class:`pycraft.server.final.Rail`
...
Python Proxy to `org.bukkit.block.data.type.RedstoneRail <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/RedstoneRail.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: RedstoneRail(self, string_value=None, **named)
   :canonical: pycraft.server.final.RedstoneRail
   ...
   .. py:method:: getShape(self) -> :py:class:`Shape`
      :async:


   .. py:method:: getShapes(self) -> typing.List[:py:class:`Shape`]
      :async:
   ...
   .. py:method:: setShape(self, _0:Shape) -> None
      :async:
