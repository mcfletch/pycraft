...
Inheritance
------------
* pycraft.server.final.RedstoneWallTorch
* :py:class:`pycraft.server.world.RedstoneWallTorch`
...
Python Proxy to `org.bukkit.block.data.type.RedstoneWallTorch <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/RedstoneWallTorch.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: RedstoneWallTorch(self, string_value=None, **named)
   :canonical: pycraft.server.final.RedstoneWallTorch
