...
Inheritance
------------
* pycraft.server.final.RenderType
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.scoreboard.RenderType <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/scoreboard/RenderType.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: RenderType(self, key)
   :canonical: pycraft.server.final.RenderType
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`RenderType`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`RenderType`]
      :async:
      :classmethod:
