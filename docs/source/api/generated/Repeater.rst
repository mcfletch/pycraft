...
Inheritance
------------
* pycraft.server.final.Repeater
* :py:class:`pycraft.server.world.Repeater`
...
Python Proxy to `org.bukkit.block.data.type.Repeater <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Repeater.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Repeater(self, string_value=None, **named)
   :canonical: pycraft.server.final.Repeater
   ...
   .. py:method:: getMaximumDelay(self) -> int
      :async:


   .. py:method:: getMinimumDelay(self) -> int
      :async:
   ...
   .. py:method:: setDelay(self, _0:int) -> None
      :async:
