...
Inheritance
------------
* pycraft.server.final.RespawnPhase
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.boss.DragonBattle.RespawnPhase <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/boss/DragonBattle/RespawnPhase.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: RespawnPhase(self, key)
   :canonical: pycraft.server.final.RespawnPhase
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`RespawnPhase`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`RespawnPhase`]
      :async:
      :classmethod:
