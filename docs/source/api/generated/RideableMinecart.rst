...
Inheritance
------------
* pycraft.server.final.RideableMinecart
...
Python Proxy to `org.bukkit.entity.minecart.RideableMinecart <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/minecart/RideableMinecart.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: RideableMinecart(self, **named)
   :canonical: pycraft.server.final.RideableMinecart
