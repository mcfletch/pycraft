...
Inheritance
------------
* pycraft.server.final.Rotation
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.Rotation <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/Rotation.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Rotation(self, key)
   :canonical: pycraft.server.final.Rotation
   ...
   .. py:method:: rotateClockwise(self) -> :py:class:`Rotation`
      :async:


   .. py:method:: rotateCounterClockwise(self) -> :py:class:`Rotation`
      :async:
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Rotation`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Rotation`]
      :async:
      :classmethod:
