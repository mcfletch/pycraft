...
Inheritance
------------
* pycraft.server.final.SaddledHorseInventory
...
Python Proxy to `org.bukkit.inventory.SaddledHorseInventory <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/SaddledHorseInventory.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: SaddledHorseInventory(self, *args, **named)
   :canonical: pycraft.server.final.SaddledHorseInventory
