...
Inheritance
------------
* pycraft.server.final.Salmon
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.Salmon <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Salmon.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Salmon(self, **named)
   :canonical: pycraft.server.final.Salmon
