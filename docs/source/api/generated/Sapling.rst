...
Python Proxy to `org.bukkit.block.data.type.Sapling <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Sapling.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Sapling(self, string_value=None, **named)
   :canonical: pycraft.server.final.Sapling
