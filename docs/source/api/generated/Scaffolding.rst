...
Inheritance
------------
* pycraft.server.final.Scaffolding
* :py:class:`pycraft.server.world.Scaffolding`
...
Python Proxy to `org.bukkit.block.data.type.Scaffolding <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Scaffolding.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Scaffolding(self, string_value=None, **named)
   :canonical: pycraft.server.final.Scaffolding
   ...
   .. py:method:: getDistance(self) -> int
      :async:
   ...
   .. py:method:: getMaximumDistance(self) -> int
      :async:
   ...
   .. py:method:: setBottom(self, _0:boolean) -> None
      :async:


   .. py:method:: setDistance(self, _0:int) -> None
      :async:
