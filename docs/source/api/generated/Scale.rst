...
Inheritance
------------
* pycraft.server.final.Scale
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.map.MapView.Scale <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/map/MapView/Scale.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Scale(self, key)
   :canonical: pycraft.server.final.Scale
   ...
   .. py:method:: getValue(self) -> :py:class:`byte`
      :async:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Scale`]
      :async:
      :classmethod:
