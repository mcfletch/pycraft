...
Inheritance
------------
* pycraft.server.final.SeaPickle
* :py:class:`pycraft.server.world.SeaPickle`
...
Python Proxy to `org.bukkit.block.data.type.SeaPickle <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/SeaPickle.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: SeaPickle(self, string_value=None, **named)
   :canonical: pycraft.server.final.SeaPickle
   ...
   .. py:method:: getMaximumPickles(self) -> int
      :async:


   .. py:method:: getMinimumPickles(self) -> int
      :async:


   .. py:method:: getPickles(self) -> int
      :async:
   ...
   .. py:method:: setPickles(self, _0:int) -> None
      :async:
