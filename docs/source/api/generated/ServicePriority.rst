...
Inheritance
------------
* pycraft.server.final.ServicePriority
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.plugin.ServicePriority <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/plugin/ServicePriority.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: ServicePriority(self, key)
   :canonical: pycraft.server.final.ServicePriority
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`ServicePriority`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`ServicePriority`]
      :async:
      :classmethod:
