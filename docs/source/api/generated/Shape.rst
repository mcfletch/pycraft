...
Inheritance
------------
* pycraft.server.final.Shape
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.block.data.Rail.Shape <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/Rail/Shape.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Shape(self, key)
   :canonical: pycraft.server.final.Shape
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Shape`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Shape`]
      :async:
      :classmethod:
