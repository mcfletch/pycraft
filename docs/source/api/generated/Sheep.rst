...
Python Proxy to `org.bukkit.entity.Sheep <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Sheep.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Sheep(self, **named)
   :canonical: pycraft.server.final.Sheep
   ...
   .. py:method:: setSheared(self, _0:boolean) -> None
      :async:
