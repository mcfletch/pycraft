...
Python Proxy to `org.bukkit.entity.Shulker <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Shulker.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Shulker(self, **named)
   :canonical: pycraft.server.final.Shulker
   ...
   .. py:method:: setAttachedFace(self, _0:BlockFace) -> None
      :async:
   ...
   .. py:method:: setPeek(self, _0:float) -> None
      :async:
