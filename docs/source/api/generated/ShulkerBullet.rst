...
Inheritance
------------
* pycraft.server.final.ShulkerBullet
...
Python Proxy to `org.bukkit.entity.ShulkerBullet <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/ShulkerBullet.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: ShulkerBullet(self, **named)
   :canonical: pycraft.server.final.ShulkerBullet
   ...
   .. py:method:: getCurrentMovementDirection(self) -> :py:class:`BlockFace`
      :async:
   ...
   .. py:method:: getFlightSteps(self) -> int
      :async:
   ...
   .. py:method:: getTarget(self) -> :py:class:`Entity`
      :async:


   .. py:method:: getTargetDelta(self) -> :py:class:`Vector`
      :async:
   ...
   .. py:method:: setCurrentMovementDirection(self, _0:BlockFace) -> None
      :async:
   ...
   .. py:method:: setFlightSteps(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setTarget(self, _0:Entity) -> None
      :async:


   .. py:method:: setTargetDelta(self, _0:Vector) -> None
      :async:
