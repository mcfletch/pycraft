...
Inheritance
------------
* pycraft.server.final.Silverfish
...
Python Proxy to `org.bukkit.entity.Silverfish <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Silverfish.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Silverfish(self, **named)
   :canonical: pycraft.server.final.Silverfish
