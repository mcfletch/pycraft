...
Inheritance
------------
* pycraft.server.final.SizedFireball
...
Python Proxy to `org.bukkit.entity.SizedFireball <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/SizedFireball.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: SizedFireball(self, **named)
   :canonical: pycraft.server.final.SizedFireball
