...
Inheritance
------------
* pycraft.server.final.Skeleton
* :py:class:`pycraft.server.final.AbstractSkeleton`
...
Python Proxy to `org.bukkit.entity.Skeleton <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Skeleton.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Skeleton(self, **named)
   :canonical: pycraft.server.final.Skeleton
   ...
   .. py:method:: getSkeletonType(self) -> :py:class:`SkeletonType`
      :async:
   ...
   .. py:method:: inPowderedSnowTime(self) -> int
      :async:
   ...
   .. py:method:: setSkeletonType(self, _0:SkeletonType) -> None
      :async:
