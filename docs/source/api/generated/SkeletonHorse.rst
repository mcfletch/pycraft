...
Inheritance
------------
* pycraft.server.final.SkeletonHorse
...
Python Proxy to `org.bukkit.entity.SkeletonHorse <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/SkeletonHorse.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: SkeletonHorse(self, **named)
   :canonical: pycraft.server.final.SkeletonHorse
   ...
   .. py:method:: getTrapTime(self) -> int
      :async:
   ...
   .. py:method:: isTrap(self) -> bool
      :async:


   .. py:method:: isTrapped(self) -> bool
      :async:
   ...
   .. py:method:: setTrap(self, _0:boolean) -> None
      :async:


   .. py:method:: setTrapTime(self, _0:int) -> None
      :async:


   .. py:method:: setTrapped(self, _0:boolean) -> None
      :async:
