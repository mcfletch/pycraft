...
Inheritance
------------
* pycraft.server.final.SkeletonType
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.Skeleton.SkeletonType <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Skeleton/SkeletonType.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: SkeletonType(self, key)
   :canonical: pycraft.server.final.SkeletonType
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`SkeletonType`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`SkeletonType`]
      :async:
      :classmethod:
