...
Inheritance
------------
* pycraft.server.final.SkinModel
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.profile.PlayerTextures.SkinModel <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/profile/PlayerTextures/SkinModel.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: SkinModel(self, key)
   :canonical: pycraft.server.final.SkinModel
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`SkinModel`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`SkinModel`]
      :async:
      :classmethod:
