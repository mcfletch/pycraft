...
Inheritance
------------
* pycraft.server.final.Slab
* :py:class:`pycraft.server.world.Slab`
...
Python Proxy to `org.bukkit.block.data.type.Slab <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Slab.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Slab(self, string_value=None, **named)
   :canonical: pycraft.server.final.Slab
