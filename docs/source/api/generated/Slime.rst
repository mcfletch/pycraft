...
Python Proxy to `org.bukkit.entity.Slime <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Slime.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Slime(self, **named)
   :canonical: pycraft.server.final.Slime
