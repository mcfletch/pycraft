...
Inheritance
------------
* pycraft.server.final.SlotType
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.event.inventory.InventoryType.SlotType <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/event/inventory/InventoryType/SlotType.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: SlotType(self, key)
   :canonical: pycraft.server.final.SlotType
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`SlotType`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`SlotType`]
      :async:
      :classmethod:
