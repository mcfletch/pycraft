...
Inheritance
------------
* pycraft.server.final.SmallFireball
* :py:class:`pycraft.server.final.SizedFireball`
* :py:class:`pycraft.server.final.Fireball`
* :py:class:`pycraft.server.final.Projectile`
* :py:class:`pycraft.server.final.Explosive`
...
Python Proxy to `org.bukkit.entity.SmallFireball <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/SmallFireball.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: SmallFireball(self, **named)
   :canonical: pycraft.server.final.SmallFireball
   ...
   .. py:method:: getDisplayItem(self) -> :py:class:`ItemStack`
      :async:
   ...
   .. py:method:: isIncendiary(self) -> bool
      :async:
   ...
   .. py:method:: setDirection(self, _0:Vector) -> None
      :async:


   .. py:method:: setDisplayItem(self, _0:ItemStack) -> None
      :async:
   ...
   .. py:method:: setIsIncendiary(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setYield(self, _0:float) -> None
      :async:
