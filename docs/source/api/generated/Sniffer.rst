...
Python Proxy to `org.bukkit.entity.Sniffer <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Sniffer.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Sniffer(self, **named)
   :canonical: pycraft.server.final.Sniffer
   ...
   .. py:method:: addExploredLocation(self, _0:Location) -> None
      :async:
   ...
   .. py:method:: findPossibleDigLocation(self) -> :py:class:`Location`
      :async:
   ...
   .. py:method:: getExploredLocations(self) -> typing.List[:py:class:`Location`]
      :async:
   ...
   .. py:method:: getState(self) -> :py:class:`State`
      :async:
   ...
   .. py:method:: removeExploredLocation(self, _0:Location) -> None
      :async:
   ...
   .. py:method:: setState(self, _0:State) -> None
      :async:
