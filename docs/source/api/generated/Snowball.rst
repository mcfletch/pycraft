...
Python Proxy to `org.bukkit.entity.Snowball <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Snowball.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Snowball(self, **named)
   :canonical: pycraft.server.final.Snowball
