...
Inheritance
------------
* pycraft.server.final.Snowman
* :py:class:`pycraft.server.final.Golem`
...
Python Proxy to `org.bukkit.entity.Snowman <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Snowman.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Snowman(self, **named)
   :canonical: pycraft.server.final.Snowman
   ...
   .. py:method:: setDerp(self, _0:boolean) -> None
      :async:
