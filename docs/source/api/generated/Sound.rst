...
Inheritance
------------
* pycraft.server.final.Sound
* :py:class:`pycraft.server.world.Sound`
...
Python Proxy to `org.bukkit.Sound <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/Sound.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Sound(self, key)
   :canonical: pycraft.server.final.Sound
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Sound`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Sound`]
      :async:
      :classmethod:
