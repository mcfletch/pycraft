...
Inheritance
------------
* pycraft.server.final.SoundCategory
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.SoundCategory <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/SoundCategory.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: SoundCategory(self, key)
   :canonical: pycraft.server.final.SoundCategory
   ...
   .. py:method:: soundSource(self) -> :py:class:`Source`
      :async:
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`SoundCategory`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`SoundCategory`]
      :async:
      :classmethod:
