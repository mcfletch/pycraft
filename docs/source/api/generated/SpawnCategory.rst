...
Inheritance
------------
* pycraft.server.final.SpawnCategory
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.SpawnCategory <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/SpawnCategory.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: SpawnCategory(self, key)
   :canonical: pycraft.server.final.SpawnCategory
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`SpawnCategory`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`SpawnCategory`]
      :async:
      :classmethod:
