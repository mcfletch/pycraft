...
Inheritance
------------
* pycraft.server.final.SpawnEggMeta
...
Python Proxy to `org.bukkit.inventory.meta.SpawnEggMeta <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/meta/SpawnEggMeta.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: SpawnEggMeta(self, **named)
   :canonical: pycraft.server.final.SpawnEggMeta
   ...
   .. py:method:: getCustomSpawnedType(self) -> :py:class:`EntityType`
      :async:
   ...
   .. py:method:: getSpawnedType(self) -> :py:class:`EntityType`
      :async:
   ...
   .. py:method:: setCustomSpawnedType(self, _0:EntityType) -> None
      :async:
   ...
   .. py:method:: setSpawnedType(self, _0:EntityType) -> None
      :async:
