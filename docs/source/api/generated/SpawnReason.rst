...
Inheritance
------------
* pycraft.server.final.SpawnReason
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.event.entity.CreatureSpawnEvent.SpawnReason <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/event/entity/CreatureSpawnEvent/SpawnReason.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: SpawnReason(self, key)
   :canonical: pycraft.server.final.SpawnReason
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`SpawnReason`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`SpawnReason`]
      :async:
      :classmethod:
