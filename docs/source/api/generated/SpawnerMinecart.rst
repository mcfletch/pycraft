...
Inheritance
------------
* pycraft.server.final.SpawnerMinecart
...
Python Proxy to `org.bukkit.entity.minecart.SpawnerMinecart <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/minecart/SpawnerMinecart.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: SpawnerMinecart(self, **named)
   :canonical: pycraft.server.final.SpawnerMinecart
