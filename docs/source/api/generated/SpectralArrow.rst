...
Inheritance
------------
* pycraft.server.final.SpectralArrow
...
Python Proxy to `org.bukkit.entity.SpectralArrow <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/SpectralArrow.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: SpectralArrow(self, **named)
   :canonical: pycraft.server.final.SpectralArrow
   ...
   .. py:method:: getGlowingTicks(self) -> int
      :async:
   ...
   .. py:method:: setGlowingTicks(self, _0:int) -> None
      :async:
