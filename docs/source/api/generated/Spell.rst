...
Inheritance
------------
* pycraft.server.final.Spell
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.Spellcaster.Spell <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Spellcaster/Spell.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Spell(self, key)
   :canonical: pycraft.server.final.Spell
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Spell`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Spell`]
      :async:
      :classmethod:
