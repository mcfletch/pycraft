...
Inheritance
------------
* pycraft.server.final.Spellcaster
...
Python Proxy to `org.bukkit.entity.Spellcaster <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Spellcaster.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Spellcaster(self, **named)
   :canonical: pycraft.server.final.Spellcaster
