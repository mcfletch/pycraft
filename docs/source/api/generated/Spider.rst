...
Python Proxy to `org.bukkit.entity.Spider <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Spider.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Spider(self, **named)
   :canonical: pycraft.server.final.Spider
