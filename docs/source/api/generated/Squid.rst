...
Python Proxy to `org.bukkit.entity.Squid <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Squid.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Squid(self, **named)
   :canonical: pycraft.server.final.Squid
