...
Inheritance
------------
* pycraft.server.final.Stairs
* :py:class:`pycraft.server.world.Stairs`
...
Python Proxy to `org.bukkit.block.data.type.Stairs <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Stairs.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Stairs(self, string_value=None, **named)
   :canonical: pycraft.server.final.Stairs
