...
Inheritance
------------
* pycraft.server.final.State
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.Sniffer.State <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Sniffer/State.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: State(self, key)
   :canonical: pycraft.server.final.State
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`State`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`State`]
      :async:
      :classmethod:
