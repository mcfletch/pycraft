...
Inheritance
------------
* pycraft.server.final.Status
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.event.player.PlayerResourcePackStatusEvent.Status <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/event/player/PlayerResourcePackStatusEvent/Status.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Status(self, key)
   :canonical: pycraft.server.final.Status
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Status`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Status`]
      :async:
      :classmethod:
