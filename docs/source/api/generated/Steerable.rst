...
Inheritance
------------
* pycraft.server.final.Steerable
...
Python Proxy to `org.bukkit.entity.Steerable <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Steerable.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Steerable(self, **named)
   :canonical: pycraft.server.final.Steerable
