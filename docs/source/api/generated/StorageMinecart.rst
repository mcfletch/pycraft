...
Inheritance
------------
* pycraft.server.final.StorageMinecart
...
Python Proxy to `org.bukkit.entity.minecart.StorageMinecart <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/minecart/StorageMinecart.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: StorageMinecart(self, **named)
   :canonical: pycraft.server.final.StorageMinecart
