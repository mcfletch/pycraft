...
Python Proxy to `org.bukkit.entity.Stray <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Stray.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Stray(self, **named)
   :canonical: pycraft.server.final.Stray
