...
Inheritance
------------
* pycraft.server.final.Strider
* :py:class:`pycraft.server.final.Steerable`
...
Python Proxy to `org.bukkit.entity.Strider <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Strider.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Strider(self, **named)
   :canonical: pycraft.server.final.Strider
   ...
   .. py:method:: getBoostTicks(self) -> int
      :async:
   ...
   .. py:method:: getCurrentBoostTicks(self) -> int
      :async:
   ...
   .. py:method:: getSteerMaterial(self) -> :py:class:`Material`
      :async:
   ...
   .. py:method:: isShivering(self) -> bool
      :async:
   ...
   .. py:method:: setBoostTicks(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setCurrentBoostTicks(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setSaddle(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setShivering(self, _0:boolean) -> None
      :async:
