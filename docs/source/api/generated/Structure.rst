...
Inheritance
------------
* pycraft.server.final.Structure
...
Python Proxy to `org.bukkit.generator.structure.Structure <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/generator/structure/Structure.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Structure(self, key)
   :canonical: pycraft.server.final.Structure
   ...
   .. py:method:: getStructureType(self) -> :py:class:`StructureType`
      :async:
