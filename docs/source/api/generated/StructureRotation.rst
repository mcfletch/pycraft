...
Inheritance
------------
* pycraft.server.final.StructureRotation
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.block.structure.StructureRotation <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/structure/StructureRotation.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: StructureRotation(self, key)
   :canonical: pycraft.server.final.StructureRotation
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`StructureRotation`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`StructureRotation`]
      :async:
      :classmethod:
