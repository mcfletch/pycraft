...
Inheritance
------------
* pycraft.server.final.StructureType
...
Python Proxy to `org.bukkit.generator.structure.StructureType <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/generator/structure/StructureType.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: StructureType(self, key)
   :canonical: pycraft.server.final.StructureType
