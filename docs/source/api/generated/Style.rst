...
Inheritance
------------
* pycraft.server.final.Style
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.Horse.Style <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Horse/Style.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Style(self, key)
   :canonical: pycraft.server.final.Style
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Style`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Style`]
      :async:
      :classmethod:
