...
Inheritance
------------
* pycraft.server.final.SuspiciousStewMeta
...
Python Proxy to `org.bukkit.inventory.meta.SuspiciousStewMeta <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/meta/SuspiciousStewMeta.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: SuspiciousStewMeta(self, **named)
   :canonical: pycraft.server.final.SuspiciousStewMeta
