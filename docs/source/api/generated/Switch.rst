...
Inheritance
------------
* pycraft.server.final.Switch
* :py:class:`pycraft.server.world.Switch`
...
Python Proxy to `org.bukkit.block.data.type.Switch <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Switch.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Switch(self, string_value=None, **named)
   :canonical: pycraft.server.final.Switch
   ...
   .. py:method:: getFace(self) -> :py:class:`Face`
      :async:
   ...
   .. py:method:: setFace(self, _0:Face) -> None
      :async:
