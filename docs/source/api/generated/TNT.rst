...
Inheritance
------------
* pycraft.server.final.TNT
* :py:class:`pycraft.server.world.TNT`
* :py:class:`pycraft.server.final.BlockData`
* :py:class:`pycraft.server.world.BlockData`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.block.data.type.TNT <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/TNT.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: TNT(self, string_value=None, **named)
   :canonical: pycraft.server.final.TNT
   ...
   .. py:method:: isUnstable(self) -> bool
      :async:
   ...
   .. py:method:: setUnstable(self, _0:boolean) -> None
      :async:
