...
Inheritance
------------
* pycraft.server.final.TNTPrimed
...
Python Proxy to `org.bukkit.entity.TNTPrimed <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/TNTPrimed.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: TNTPrimed(self, **named)
   :canonical: pycraft.server.final.TNTPrimed
   ...
   .. py:method:: getSource(self) -> :py:class:`Entity`
      :async:
   ...
   .. py:method:: setSource(self, _0:Entity) -> None
      :async:
