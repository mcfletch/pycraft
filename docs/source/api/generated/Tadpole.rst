...
Inheritance
------------
* pycraft.server.final.Tadpole
* :py:class:`pycraft.server.final.Fish`
* :py:class:`pycraft.server.final.WaterMob`
...
Python Proxy to `org.bukkit.entity.Tadpole <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Tadpole.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Tadpole(self, **named)
   :canonical: pycraft.server.final.Tadpole
