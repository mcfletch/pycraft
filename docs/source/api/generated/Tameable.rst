...
Python Proxy to `org.bukkit.entity.Tameable <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Tameable.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Tameable(self, **named)
   :canonical: pycraft.server.final.Tameable
