...
Inheritance
------------
* pycraft.server.final.TechnicalPiston
...
Python Proxy to `org.bukkit.block.data.type.TechnicalPiston <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/TechnicalPiston.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: TechnicalPiston(self, string_value=None, **named)
   :canonical: pycraft.server.final.TechnicalPiston
