...
Inheritance
------------
* pycraft.server.final.TeleportCause
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.event.player.PlayerTeleportEvent.TeleportCause <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/event/player/PlayerTeleportEvent/TeleportCause.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: TeleportCause(self, key)
   :canonical: pycraft.server.final.TeleportCause
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`TeleportCause`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`TeleportCause`]
      :async:
      :classmethod:
