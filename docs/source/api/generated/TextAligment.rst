...
Inheritance
------------
* pycraft.server.final.TextAligment
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.TextDisplay.TextAligment <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/TextDisplay/TextAligment.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: TextAligment(self, key)
   :canonical: pycraft.server.final.TextAligment
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`TextAligment`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`TextAligment`]
      :async:
      :classmethod:
