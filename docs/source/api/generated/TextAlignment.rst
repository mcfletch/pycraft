...
Inheritance
------------
* pycraft.server.final.TextAlignment
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.TextDisplay.TextAlignment <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/TextDisplay/TextAlignment.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: TextAlignment(self, key)
   :canonical: pycraft.server.final.TextAlignment
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`TextAlignment`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`TextAlignment`]
      :async:
      :classmethod:
