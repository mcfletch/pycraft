...
Inheritance
------------
* pycraft.server.final.TextDisplay
* :py:class:`pycraft.server.final.Display`
...
Python Proxy to `org.bukkit.entity.TextDisplay <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/TextDisplay.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: TextDisplay(self, **named)
   :canonical: pycraft.server.final.TextDisplay
   ...
   .. py:method:: getAlignment(self) -> :py:class:`TextAlignment`
      :async:


   .. py:method:: getBackgroundColor(self) -> :py:class:`Color`
      :async:


   .. py:method:: getBillboard(self) -> :py:class:`Billboard`
      :async:
   ...
   .. py:method:: getBrightness(self) -> :py:class:`Brightness`
      :async:
   ...
   .. py:method:: getDisplayHeight(self) -> float
      :async:


   .. py:method:: getDisplayWidth(self) -> float
      :async:
   ...
   .. py:method:: getGlowColorOverride(self) -> :py:class:`Color`
      :async:
   ...
   .. py:method:: getInterpolationDelay(self) -> int
      :async:


   .. py:method:: getInterpolationDuration(self) -> int
      :async:
   ...
   .. py:method:: getLineWidth(self) -> int
      :async:
   ...
   .. py:method:: getShadowRadius(self) -> float
      :async:


   .. py:method:: getShadowStrength(self) -> float
      :async:
   ...
   .. py:method:: getText(self) -> str
      :async:


   .. py:method:: getTextOpacity(self) -> :py:class:`byte`
      :async:
   ...
   .. py:method:: getTransformation(self) -> :py:class:`Transformation`
      :async:
   ...
   .. py:method:: getViewRange(self) -> float
      :async:
   ...
   .. py:method:: isDefaultBackground(self) -> bool
      :async:
   ...
   .. py:method:: isSeeThrough(self) -> bool
      :async:


   .. py:method:: isShadowed(self) -> bool
      :async:
   ...
   .. py:method:: setAlignment(self, _0:TextAlignment) -> None
      :async:


   .. py:method:: setBackgroundColor(self, _0:Color) -> None
      :async:


   .. py:method:: setBillboard(self, _0:Billboard) -> None
      :async:


   .. py:method:: setBrightness(self, _0:Brightness) -> None
      :async:
   ...
   .. py:method:: setDefaultBackground(self, _0:boolean) -> None
      :async:


   .. py:method:: setDisplayHeight(self, _0:float) -> None
      :async:


   .. py:method:: setDisplayWidth(self, _0:float) -> None
      :async:
   ...
   .. py:method:: setGlowColorOverride(self, _0:Color) -> None
      :async:
   ...
   .. py:method:: setInterpolationDelay(self, _0:int) -> None
      :async:


   .. py:method:: setInterpolationDuration(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setLineWidth(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setSeeThrough(self, _0:boolean) -> None
      :async:


   .. py:method:: setShadowRadius(self, _0:float) -> None
      :async:


   .. py:method:: setShadowStrength(self, _0:float) -> None
      :async:


   .. py:method:: setShadowed(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setText(self, _0:String) -> None
      :async:


   .. py:method:: setTextOpacity(self, _0:byte) -> None
      :async:
   ...
   .. py:method:: setTransformation(self, _0:Transformation) -> None
      :async:
   ...
   .. py:method:: setViewRange(self, _0:float) -> None
      :async:
   ...
   .. py:method:: text
       ...
       .. py:method:: text(self) -> :py:class:`Component`
          :async:
          :noindex:

       .. py:method:: text(self, _0:Component) -> None
          :async:
          :noindex:
