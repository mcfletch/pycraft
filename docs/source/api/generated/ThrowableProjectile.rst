...
Inheritance
------------
* pycraft.server.final.ThrowableProjectile
...
Python Proxy to `org.bukkit.entity.ThrowableProjectile <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/ThrowableProjectile.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: ThrowableProjectile(self, **named)
   :canonical: pycraft.server.final.ThrowableProjectile
