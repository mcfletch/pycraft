...
Inheritance
------------
* pycraft.server.final.ThrownExpBottle
...
Python Proxy to `org.bukkit.entity.ThrownExpBottle <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/ThrownExpBottle.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: ThrownExpBottle(self, **named)
   :canonical: pycraft.server.final.ThrownExpBottle
