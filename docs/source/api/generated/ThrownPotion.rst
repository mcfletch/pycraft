...
Inheritance
------------
* pycraft.server.final.ThrownPotion
...
Python Proxy to `org.bukkit.entity.ThrownPotion <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/ThrownPotion.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: ThrownPotion(self, **named)
   :canonical: pycraft.server.final.ThrownPotion
   ...
   .. py:method:: getEffects(self) -> typing.List[:py:class:`PotionEffect`]
      :async:
   ...
   .. py:method:: getPotionMeta(self) -> :py:class:`PotionMeta`
      :async:
   ...
   .. py:method:: setPotionMeta(self, _0:PotionMeta) -> None
      :async:
