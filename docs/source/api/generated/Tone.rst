...
Inheritance
------------
* pycraft.server.final.Tone
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.Note.Tone <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/Note/Tone.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Tone(self, key)
   :canonical: pycraft.server.final.Tone
   ...
   .. py:method:: getById(cls, _0:byte) -> :py:class:`Tone`
      :async:
      :classmethod:
   ...
   .. py:method:: getId
       ...
       .. py:method:: getId(self, _0:boolean) -> :py:class:`byte`
          :async:
          :noindex:
   ...
   .. py:method:: isSharpable(self) -> bool
      :async:


   .. py:method:: isSharped(self, _0:byte) -> bool
      :async:
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Tone`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Tone`]
      :async:
      :classmethod:
