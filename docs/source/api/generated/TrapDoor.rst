...
Inheritance
------------
* pycraft.server.final.TrapDoor
* :py:class:`pycraft.server.world.TrapDoor`
...
Python Proxy to `org.bukkit.block.data.type.TrapDoor <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/TrapDoor.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: TrapDoor(self, string_value=None, **named)
   :canonical: pycraft.server.final.TrapDoor
