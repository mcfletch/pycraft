...
Inheritance
------------
* pycraft.server.final.TreeSpecies
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.TreeSpecies <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/TreeSpecies.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: TreeSpecies(self, key)
   :canonical: pycraft.server.final.TreeSpecies
   ...
   .. py:method:: getByData(cls, _0:byte) -> :py:class:`TreeSpecies`
      :async:
      :classmethod:
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`TreeSpecies`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`TreeSpecies`]
      :async:
      :classmethod:
