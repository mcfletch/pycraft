...
Inheritance
------------
* pycraft.server.final.TreeType
* :py:class:`pycraft.server.world.TreeType`
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.TreeType <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/TreeType.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: TreeType(self, key)
   :canonical: pycraft.server.final.TreeType
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`TreeType`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`TreeType`]
      :async:
      :classmethod:
