...
Inheritance
------------
* pycraft.server.final.Trident
* :py:class:`pycraft.server.final.AbstractArrow`
* :py:class:`pycraft.server.final.ThrowableProjectile`
...
Python Proxy to `org.bukkit.entity.Trident <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Trident.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Trident(self, **named)
   :canonical: pycraft.server.final.Trident
   ...
   .. py:method:: getLoyaltyLevel(self) -> int
      :async:
   ...
   .. py:method:: hasDealtDamage(self) -> bool
      :async:


   .. py:method:: hasGlint(self) -> bool
      :async:
   ...
   .. py:method:: setGlint(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setHasDealtDamage(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setLoyaltyLevel(self, _0:int) -> None
      :async:
