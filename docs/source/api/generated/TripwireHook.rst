...
Inheritance
------------
* pycraft.server.final.TripwireHook
* :py:class:`pycraft.server.world.TripwireHook`
...
Python Proxy to `org.bukkit.block.data.type.TripwireHook <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/TripwireHook.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: TripwireHook(self, string_value=None, **named)
   :canonical: pycraft.server.final.TripwireHook
