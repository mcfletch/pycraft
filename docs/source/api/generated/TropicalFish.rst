...
Inheritance
------------
* pycraft.server.final.TropicalFish
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.TropicalFish <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/TropicalFish.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: TropicalFish(self, **named)
   :canonical: pycraft.server.final.TropicalFish
   ...
   .. py:method:: getBodyColor(self) -> :py:class:`DyeColor`
      :async:
   ...
   .. py:method:: getMaxSchoolSize(self) -> int
      :async:
   ...
   .. py:method:: getPattern(self) -> :py:class:`Pattern`
      :async:


   .. py:method:: getPatternColor(self) -> :py:class:`DyeColor`
      :async:
   ...
   .. py:method:: getSchoolLeader(self) -> :py:class:`SchoolableFish`
      :async:


   .. py:method:: getSchoolSize(self) -> int
      :async:
   ...
   .. py:method:: setBodyColor(self, _0:DyeColor) -> None
      :async:
   ...
   .. py:method:: setPattern(self, _0:Pattern) -> None
      :async:


   .. py:method:: setPatternColor(self, _0:DyeColor) -> None
      :async:
   ...
   .. py:method:: startFollowing(self, _0:SchoolableFish) -> None
      :async:


   .. py:method:: stopFollowing(self) -> None
      :async:
