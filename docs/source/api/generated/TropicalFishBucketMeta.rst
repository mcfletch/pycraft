...
Inheritance
------------
* pycraft.server.final.TropicalFishBucketMeta
...
Python Proxy to `org.bukkit.inventory.meta.TropicalFishBucketMeta <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/inventory/meta/TropicalFishBucketMeta.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: TropicalFishBucketMeta(self, **named)
   :canonical: pycraft.server.final.TropicalFishBucketMeta
   ...
   .. py:method:: hasVariant(self) -> bool
      :async:
