...
Python Proxy to `org.bukkit.entity.Turtle <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Turtle.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Turtle(self, **named)
   :canonical: pycraft.server.final.Turtle
   ...
   .. py:method:: getHome(self) -> :py:class:`Location`
      :async:
   ...
   .. py:method:: isGoingHome(self) -> bool
      :async:
   ...
   .. py:method:: isLayingEgg(self) -> bool
      :async:
   ...
   .. py:method:: setHasEgg(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setHome(self, _0:Location) -> None
      :async:
