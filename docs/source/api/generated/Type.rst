...
Python Proxy to `org.bukkit.entity.Villager.Type <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Villager/Type.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Type(self, key)
   :canonical: pycraft.server.final.Type
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Type`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Type`]
      :async:
      :classmethod:
