...
Inheritance
------------
* pycraft.server.final.Variant
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.Horse.Variant <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Horse/Variant.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Variant(self, key)
   :canonical: pycraft.server.final.Variant
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`Variant`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`Variant`]
      :async:
      :classmethod:
