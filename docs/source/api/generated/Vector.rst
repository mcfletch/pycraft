...
Inheritance
------------
* pycraft.server.final.Vector
* :py:class:`pycraft.server.world.Vector`
* :py:class:`pycraft.server.final.ConfigurationSerializable`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.util.Vector <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/util/Vector.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Vector(self, record, *args)
   :canonical: pycraft.server.final.Vector
