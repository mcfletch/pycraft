...
Python Proxy to `org.bukkit.entity.Vehicle <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Vehicle.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Vehicle(self, **named)
   :canonical: pycraft.server.final.Vehicle
