...
Python Proxy to `org.bukkit.entity.Vex <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Vex.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Vex(self, **named)
   :canonical: pycraft.server.final.Vex
   ...
   .. py:method:: getBound(self) -> :py:class:`Location`
      :async:
   ...
   .. py:method:: getLifeTicks(self) -> int
      :async:


   .. py:method:: getLimitedLifetimeTicks(self) -> int
      :async:
   ...
   .. py:method:: getSummoner(self) -> :py:class:`Mob`
      :async:
   ...
   .. py:method:: hasLimitedLife(self) -> bool
      :async:


   .. py:method:: hasLimitedLifetime(self) -> bool
      :async:
   ...
   .. py:method:: isCharging(self) -> bool
      :async:
   ...
   .. py:method:: setBound(self, _0:Location) -> None
      :async:
   ...
   .. py:method:: setCharging(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setLifeTicks(self, _0:int) -> None
      :async:


   .. py:method:: setLimitedLifetime(self, _0:boolean) -> None
      :async:


   .. py:method:: setLimitedLifetimeTicks(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setSummoner(self, _0:Mob) -> None
      :async:
