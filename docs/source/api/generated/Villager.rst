...
Inheritance
------------
* pycraft.server.final.Villager
* :py:class:`pycraft.server.final.AbstractVillager`
* :py:class:`pycraft.server.final.Breedable`
* :py:class:`pycraft.server.final.Ageable`
* :py:class:`pycraft.server.final.NPC`
...
* :py:class:`pycraft.server.final.Merchant`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.entity.Villager <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Villager.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Villager(self, **named)
   :canonical: pycraft.server.final.Villager
   ...
   .. py:method:: addTrades(self, _0:int) -> bool
      :async:
   ...
   .. py:method:: clearReputations(self) -> None
      :async:
   ...
   .. py:method:: getProfession(self) -> :py:class:`Profession`
      :async:
   ...
   .. py:method:: getReputation(self, _0:UUID) -> :py:class:`Reputation`
      :async:


   .. py:method:: getReputations(self) -> :py:class:`Map`
      :async:


   .. py:method:: getRestocksToday(self) -> int
      :async:
   ...
   .. py:method:: getVillagerLevel(self) -> int
      :async:
   ...
   .. py:method:: increaseLevel(self, _0:int) -> bool
      :async:
   ...
   .. py:method:: resetOffers(self) -> None
      :async:
   ...
   .. py:method:: setProfession(self, _0:Profession) -> None
      :async:
   ...
   .. py:method:: setReputation(self, _0:UUID, _1:Reputation) -> None
      :async:


   .. py:method:: setReputations(self, _0:Map) -> None
      :async:


   .. py:method:: setRestocksToday(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setVillagerLevel(self, _0:int) -> None
      :async:
   ...
   .. py:method:: sleep(self, _0:Location) -> bool
      :async:
   ...
   .. py:method:: zombify(self) -> :py:class:`ZombieVillager`
      :async:
