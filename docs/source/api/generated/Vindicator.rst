...
Inheritance
------------
* pycraft.server.final.Vindicator
...
Python Proxy to `org.bukkit.entity.Vindicator <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Vindicator.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Vindicator(self, **named)
   :canonical: pycraft.server.final.Vindicator
   ...
   .. py:method:: setJohnny(self, _0:boolean) -> None
      :async:
