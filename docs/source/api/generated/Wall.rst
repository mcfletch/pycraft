...
Inheritance
------------
* pycraft.server.final.Wall
* :py:class:`pycraft.server.world.Wall`
...
Python Proxy to `org.bukkit.block.data.type.Wall <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/Wall.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Wall(self, string_value=None, **named)
   :canonical: pycraft.server.final.Wall
   ...
   .. py:method:: getHeight(self, _0:BlockFace) -> :py:class:`Height`
      :async:
   ...
   .. py:method:: setHeight(self, _0:BlockFace, _1:Height) -> None
      :async:


   .. py:method:: setUp(self, _0:boolean) -> None
      :async:
