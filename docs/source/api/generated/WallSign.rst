...
Inheritance
------------
* pycraft.server.final.WallSign
* :py:class:`pycraft.server.world.WallSign`
...
Python Proxy to `org.bukkit.block.data.type.WallSign <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/block/data/type/WallSign.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: WallSign(self, string_value=None, **named)
   :canonical: pycraft.server.final.WallSign
