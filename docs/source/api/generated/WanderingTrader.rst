...
Inheritance
------------
* pycraft.server.final.WanderingTrader
...
Python Proxy to `org.bukkit.entity.WanderingTrader <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/WanderingTrader.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: WanderingTrader(self, **named)
   :canonical: pycraft.server.final.WanderingTrader
   ...
   .. py:method:: canDrinkMilk(self) -> bool
      :async:


   .. py:method:: canDrinkPotion(self) -> bool
      :async:
   ...
   .. py:method:: getDespawnDelay(self) -> int
      :async:
   ...
   .. py:method:: getWanderingTowards(self) -> :py:class:`Location`
      :async:
   ...
   .. py:method:: setCanDrinkMilk(self, _0:boolean) -> None
      :async:


   .. py:method:: setCanDrinkPotion(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setDespawnDelay(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setWanderingTowards(self, _0:Location) -> None
      :async:
