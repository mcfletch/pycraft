...
Python Proxy to `org.bukkit.entity.Warden <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Warden.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Warden(self, **named)
   :canonical: pycraft.server.final.Warden
   ...
   .. py:method:: clearAnger(self, _0:Entity) -> None
      :async:
   ...
   .. py:method:: getAnger
       ...
       .. py:method:: getAnger(self, _0:Entity) -> int
          :async:
          :noindex:


   .. py:method:: getAngerLevel(self) -> :py:class:`AngerLevel`
      :async:
   ...
   .. py:method:: getEntityAngryAt(self) -> :py:class:`LivingEntity`
      :async:
   ...
   .. py:method:: getHighestAnger(self) -> int
      :async:
   ...
   .. py:method:: increaseAnger(self, _0:Entity, _1:int) -> None
      :async:
   ...
   .. py:method:: setAnger(self, _0:Entity, _1:int) -> None
      :async:
   ...
   .. py:method:: setDisturbanceLocation(self, _0:Location) -> None
      :async:
