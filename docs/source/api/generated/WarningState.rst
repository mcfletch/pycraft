...
Inheritance
------------
* pycraft.server.final.WarningState
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.Warning.WarningState <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/Warning/WarningState.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: WarningState(self, key)
   :canonical: pycraft.server.final.WarningState
   ...
   .. py:method:: printFor(self, _0:Warning) -> bool
      :async:
   ...
   .. py:method:: value(cls, _0:String) -> :py:class:`WarningState`
      :async:
      :classmethod:
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`WarningState`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`WarningState`]
      :async:
      :classmethod:
