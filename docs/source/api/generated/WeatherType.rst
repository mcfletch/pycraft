...
Inheritance
------------
* pycraft.server.final.WeatherType
* :py:class:`pycraft.server.proxyobjects.ServerObjectEnum`
* :py:class:`pycraft.server.proxyobjects.ServerObjectProxy`

Python Proxy to `org.bukkit.WeatherType <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/WeatherType.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: WeatherType(self, key)
   :canonical: pycraft.server.final.WeatherType
   ...
   .. py:method:: valueOf
       ...
       .. py:method:: valueOf(cls, _0:String) -> :py:class:`WeatherType`
          :async:
          :classmethod:
          :noindex:
   ...
   .. py:method:: values(cls) -> typing.List[:py:class:`WeatherType`]
      :async:
      :classmethod:
