...
Inheritance
------------
* pycraft.server.final.Witch
* :py:class:`pycraft.server.final.Raider`
...
Python Proxy to `org.bukkit.entity.Witch <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Witch.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Witch(self, **named)
   :canonical: pycraft.server.final.Witch
   ...
   .. py:method:: getCelebrationSound(self) -> :py:class:`Sound`
      :async:
   ...
   .. py:method:: getDrinkingPotion(self) -> :py:class:`ItemStack`
      :async:
   ...
   .. py:method:: getPatrolTarget(self) -> :py:class:`Block`
      :async:
   ...
   .. py:method:: getPotionUseTimeLeft(self) -> int
      :async:
   ...
   .. py:method:: isCanJoinRaid(self) -> bool
      :async:


   .. py:method:: isCelebrating(self) -> bool
      :async:
   ...
   .. py:method:: isDrinkingPotion(self) -> bool
      :async:
   ...
   .. py:method:: isPatrolLeader(self) -> bool
      :async:
   ...
   .. py:method:: setCanJoinRaid(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setCelebrating(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setDrinkingPotion(self, _0:ItemStack) -> None
      :async:
   ...
   .. py:method:: setPatrolLeader(self, _0:boolean) -> None
      :async:


   .. py:method:: setPatrolTarget(self, _0:Block) -> None
      :async:
   ...
   .. py:method:: setPotionUseTimeLeft(self, _0:int) -> None
      :async:
