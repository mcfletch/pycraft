...
* :py:class:`pycraft.server.final.Boss`
...
Python Proxy to `org.bukkit.entity.Wither <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Wither.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Wither(self, **named)
   :canonical: pycraft.server.final.Wither
   ...
   .. py:method:: canTravelThroughPortals(self) -> bool
      :async:
   ...
   .. py:method:: enterInvulnerabilityPhase(self) -> None
      :async:
   ...
   .. py:method:: getInvulnerabilityTicks(self) -> int
      :async:


   .. py:method:: getInvulnerableTicks(self) -> int
      :async:
   ...
   .. py:method:: getTarget
       ...
       .. py:method:: getTarget(self, _0:Head) -> :py:class:`LivingEntity`
          :async:
          :noindex:
   ...
   .. py:method:: setCanTravelThroughPortals(self, _0:boolean) -> None
      :async:
   ...
   .. py:method:: setInvulnerabilityTicks(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setInvulnerableTicks(self, _0:int) -> None
      :async:
   ...
   .. py:method:: setTarget
       ...
       .. py:method:: setTarget(self, _0:Head, _1:LivingEntity) -> None
          :async:
          :noindex:
