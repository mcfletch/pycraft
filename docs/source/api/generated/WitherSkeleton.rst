...
Inheritance
------------
* pycraft.server.final.WitherSkeleton
...
Python Proxy to `org.bukkit.entity.WitherSkeleton <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/WitherSkeleton.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: WitherSkeleton(self, **named)
   :canonical: pycraft.server.final.WitherSkeleton
