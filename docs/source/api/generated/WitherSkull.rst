...
Inheritance
------------
* pycraft.server.final.WitherSkull
...
Python Proxy to `org.bukkit.entity.WitherSkull <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/WitherSkull.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: WitherSkull(self, **named)
   :canonical: pycraft.server.final.WitherSkull
   ...
   .. py:method:: setCharged(self, _0:boolean) -> None
      :async:
