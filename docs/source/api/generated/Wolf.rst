...
Python Proxy to `org.bukkit.entity.Wolf <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Wolf.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Wolf(self, **named)
   :canonical: pycraft.server.final.Wolf
   ...
   .. py:method:: getTailAngle(self) -> float
      :async:
