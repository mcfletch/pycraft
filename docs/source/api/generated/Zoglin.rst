...
Python Proxy to `org.bukkit.entity.Zoglin <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Zoglin.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Zoglin(self, **named)
   :canonical: pycraft.server.final.Zoglin
