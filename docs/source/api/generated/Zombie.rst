...
Python Proxy to `org.bukkit.entity.Zombie <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/Zombie.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: Zombie(self, **named)
   :canonical: pycraft.server.final.Zombie
