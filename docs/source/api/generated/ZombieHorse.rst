...
Inheritance
------------
* pycraft.server.final.ZombieHorse
...
Python Proxy to `org.bukkit.entity.ZombieHorse <https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/ZombieHorse.html>`_ from :py:mod:`pycraft.server.final`

.. py:class:: ZombieHorse(self, **named)
   :canonical: pycraft.server.final.ZombieHorse
